(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2108], {
        ...
        12108: (t, e, r) => {
            ...
            var j = {
                    baseUrl: (0, b.default)(null != (n = s.env.NEXTAUTH_URL) ? n : s.env.VERCEL_URL).origin,
                    basePath: (0, b.default)(s.env.NEXTAUTH_URL).path,
                    baseUrlServer: (0, b.default)(null != (o = null != (a = s.env.NEXTAUTH_URL_INTERNAL) ? a : s.env.NEXTAUTH_URL) ? o : s.env.VERCEL_URL).origin,
                    basePathServer: (0, b.default)(null != (u = s.env.NEXTAUTH_URL_INTERNAL) ? u : s.env.NEXTAUTH_URL).path,
                    _lastSync: 0,
                    _session: void 0,
                ...
                L = e.SessionContext = null == (i = y.createContext) ? void 0 : i.call(y, void 0);
            ...
            function N() {
                return (N = (0, h.default)(p.default.mark(function t(e, r, n) {
                    var o, a, u, i, s, c, l, f, d, h, v, y, g, b, w, _, m;
                    return p.default.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                return u = void 0 === (a = (o = null != r ? r : {}).callbackUrl) ? window.location.href : a, s = void 0 === (i = o.redirect) || i, c = (0, x.apiBaseUrl)(j), t.next = 4, U();
                            case 4:
                                if (l = t.sent) {
                                    t.next = 8;
                                    break
                            ...
                            case 11:
                                return f = "credentials" === l[e].type, d = "email" === l[e].type, h = f || d, v = "".concat(c, "/").concat(f ? "callback" : "signin", "/").concat(e), y = "".concat(v).concat(n ? "?".concat(new URLSearchParams(n)) : ""), t.t0 = fetch, t.t1 = y, t.t2 = {
                            ...
                            case 36:
                                ...
                                return _ = null != (w = b.url) ? w : u, window.location.href = _, _.includes("#") && window.location.reload(), t.abrupt("return");
                            case 42:
        ...
        22977: (t, e, r) => {
            ...
            function o() {
                ...
                function d(t, r, n, o) {
                    var a, u, s, c, l = Object.create((r && r.prototype instanceof x ? r : x).prototype);
                    return i(l, "_invoke", {
                        value: (a = t, u = n, s = new R(o || []), c = v, function(t, r) {
                            ...
                            for (s.method = t, s.arg = r;;) {
                                ...
                                var i = h(a, u, s);
                                if ("normal" === i.type) {
                                    if (c = s.done ? g : "suspendedYield", i.arg === b) continue;
                                    return {
                                        value: i.arg,
                                        done: s.done
                                    }
                ...
                }, j(S), p(S, f, "Generator"), p(S, c, function() {
                    return this
        ...
        71883: (t, e, r) => {
            ...
            }, e.capitalize = y, e.eventsErrorHandler = function(t, e) {
            ...
            var h = e.UnknownError = function(t) {
                function e(t) {
                    var r, n;
            ...
            e.OAuthCallbackError = function(t) {
                ...
                return (0, f.default)(e, t), (0, s.default)(e)
            }(h), e.AccountNotLinkedError = function(t) {
                function e() {
                    var t;
                    (0, i.default)(this, e);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                return (0, f.default)(e, t), (0, s.default)(e)
            }(h), e.MissingAPIRoute = function(t) {
                function e() {
                    var t;
                    (0, i.default)(this, e);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                return (0, f.default)(e, t), (0, s.default)(e)
            }(h), e.MissingAuthorize = function(t) {
                function e() {
                    var t;
                    (0, i.default)(this, e);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                return (0, f.default)(e, t), (0, s.default)(e)
            }(h), e.MissingAdapterMethods = function(t) {
                function e() {
                    var t;
                    (0, i.default)(this, e);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                return (0, f.default)(e, t), (0, s.default)(e)
            }(h), e.UnsupportedStrategy = function(t) {
                function e() {
                    var t;
                    (0, i.default)(this, e);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                return (0, f.default)(e, t), (0, s.default)(e)
            }(h), e.InvalidCallbackUrl = function(t) {
                function e() {
                    var t;
                    (0, i.default)(this, e);
                    for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
