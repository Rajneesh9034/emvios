(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [9817], {
            ...
            e.getOptions = function(t) {
                ...
                for (let e = 0; e < u; e++)
                    for (let r = 0; r < u; r++) {
                        let f = (e * u + r) * 4,
                            c = n.color.light;
                        e >= l && r >= l && e < u - l && r < u - l && (c = s[+!!i[Math.floor((e - l) / a) * o + Math.floor((r - l) / a)]]), t[f++] = c.r, t[f++] = c.g, t[f++] = c.b, t[f] = c.a
                    }
            }
        },
        15580: (t, e, r) => {
        ...
        16862: (t, e, r) => {
            ...
            function u(t, e, r, i, a) {
                ...
                if (s) {
                    ...
                    return 1 === l ? (r = e, e = i = void 0) : 2 !== l || e.getContext || (i = r, r = e, e = void 0), new Promise(function(n, a) {
                        try {
                            let a = o.create(r, i);
                            n(t(a, e, i))
                        } catch (t) {
            ...
            e.create = o.create, e.toCanvas = u.bind(null, i.render), e.toDataURL = u.bind(null, i.renderToDataURL), e.toString = u.bind(null, function(t, e, r) {
                return a.render(t, r)
            })
        },
        17652: (t, e, r) => {
        ...
        36517: (t, e) => {
            ...
            e.isValid = function(t) {
                ...
                for (let l = 0; l < e; l++) {
                    ...
                    for (let s = 0; s < e; s++) {
                        let e = t.get(l, s);
                        e === a ? o++ : (o >= 5 && (n += r.N1 + (o - 5)), a = e, o = 1), (e = t.get(s, l)) === u ? i++ : (i >= 5 && (n += r.N1 + (i - 5)), u = e, i = 1)
                    }
        ...
        46087: (t, e) => {
            let r, n = [0, 26, 44, 70, 100, 134, 172, 196, 242, 292, 346, 404, 466, 532, 581, 655, 733, 815, 901, 991, 1085, 1156, 1258, 1364, 1474, 1588, 1706, 1828, 1921, 2051, 2185, 2323, 2465, 2611, 2761, 2876, 3034, 3196, 3362, 3532, 3706];
        ...
        46514: (t, e, r) => {
            ...
            e.render = function(t, e, r) {
                ...
                let u = n.getImageWidth(t.modules.size, i),
                    l = a.getContext("2d"),
                    s = l.createImageData(u, u);
                return n.qrToImageData(s.data, t, i), o = a, l.clearRect(0, 0, o.width, o.height), o.style || (o.style = {}), o.height = u, o.width = u, o.style.height = u + "px", o.style.width = u + "px", l.putImageData(s, 0, 0), a
        ...
        55908: (t, e, r) => {
            ...
            e.create = function(t, e) {
                ...
                let E = o.M;
                return void 0 !== e && (E = o.from(e.errorCorrectionLevel, o.M), r = h.from(e.version), d = s.from(e.maskPattern), e.toSJISFunc && n.setToSJISFunction(e.toSJISFunc)),
                    function(t, e, r, o) {
                        let d;
                        ...
                        let E = h.getBestVersionForData(d, r);
                        ...
                        let w = function(t, e, r) {
                                ...
                                let u = (a - o.getLengthInBits()) / 8;
                                for (let t = 0; t < u; t++) o.put(t % 2 ? 17 : 236, 8);
                                return function(t, e, r) {
                                    let o, i, a = n.getSymbolTotalCodewords(e),
                                        u = a - f.getTotalCodewordsCount(e, r),
                                        l = f.getBlocksCount(e, r),
                                        s = a % l,
                                        h = l - s,
                                        d = Math.floor(a / l),
                                        g = Math.floor(u / l),
                                    ...
                                    for (let t = 0; t < l; t++) {
                                        let e = t < h ? g : p;
                                        y[t] = A.slice(w, w + e), v[t] = E.encode(y[t]), w += e, C = Math.max(C, e)
                                    }
                                    let N = new Uint8Array(a),
                                        B = 0;
                                    for (o = 0; o < C; o++)
                                        for (i = 0; i < l; i++) o < y[i].length && (N[B++] = y[i][o]);
                                    for (o = 0; o < m; o++)
                                        for (i = 0; i < l; i++) N[B++] = v[i][o];
                                    return N
                                }(o, t, e)
                            }(e, r, d),
                            y = new a(n.getSymbolSize(e));
                        ! function(t, e) {
                            let r = t.size,
                                n = l.getPositions(e);
                        ...
                        return ! function(t, e) {
                            ...
                            for (let u = r - 1; u > 0; u -= 2)
                                for (6 === u && u--;;) {
                                    for (let r = 0; r < 2; r++)
                                        if (!t.isReserved(o, u - r)) {
                                            let n = !1;
                                            a < e.length && (n = (e[a] >>> i & 1) == 1), t.set(o, u - r, n), -1 == --i && (a++, i = 7)
                                        }
                                    if ((o += n) < 0 || r <= o) {
                                        o -= n, n = -n;
                                        break
                        ...
                        }(y, w), isNaN(o) && (o = s.getBestMask(y, m.bind(null, y, r))), s.applyMask(o, y), m(y, r, o), {
                            modules: y,
                            version: e,
                    ...
                    c = "<path " + o(a.color.dark, "stroke") + ' d="' + function(t, e, r) {
                        ...
                        for (let l = 0; l < t.length; l++) {
                            let s = Math.floor(l % e),
                                f = Math.floor(l / e);
                            s || a || (a = !0), t[l] ? (u++, l > 0 && s > 0 && t[l - 1] || (n += a ? i("M", s + r, .5 + f + r) : i("m", o, 0), o = 0, a = !1), s + 1 < e && t[l + 1] || (n += i("h", u), u = 0)) : o++
                        }
                        return n
                    }(l, u, a.margin) + '"/>',
                    h = '<svg xmlns="http://www.w3.org/2000/svg" ' + (a.width ? 'width="' + a.width + '" height="' + a.width + '" ' : "") + ('viewBox="0 0 ' + s + " ") + s + '" shape-rendering="crispEdges">' + f + c + "</svg>\n";
                    ...
                    if (t.length > 1) {
                        for (let r = 1; r <= 40; r++)
                            if (function(t, e) {
                                ...
                                }(t, r) <= e.getCapacity(r, o, a.MIXED)) return r;
                        return
                    }
        ...
        72920: (t, e, r) => {
            ...
            function d(t) {
                let e, r, o = h(l.NUMERIC, n.NUMERIC, t),
                    i = h(l.ALPHANUMERIC, n.ALPHANUMERIC, t);
                return s.isKanjiModeEnabled() ? (e = h(l.BYTE, n.BYTE, t), r = h(l.KANJI, n.KANJI, t)) : (e = h(l.BYTE_KANJI, n.BYTE, t), r = []), o.concat(i, e, r).sort(function(t, e) {
            ...
            function p(t, e) {
                let r, l = n.getBestModeForData(t);
                if ((r = n.from(e, l)) !== n.BYTE && r.bit < l.bit) throw Error('"' + t + '" cannot be encoded with mode ' + n.toString(r) + ".\n Suggested mode is: " + n.toString(l));
                        ...
                        for (let a = 0; a < t.length; a++) {
                            ...
                            for (let t = 0; t < u.length; t++) {
                                ...
                                for (let t = 0; t < i.length; t++) {
                                    let a = i[t];
                                    r[a] && r[a].node.mode === s.mode ? (o[a][f] = g(r[a].lastCount + s.length, s.mode) - g(r[a].lastCount, s.mode), r[a].lastCount += s.length) : (r[a] && (r[a].lastCount = s.length), o[a][f] = g(s.length, s.mode) + 4 + n.getCharCountIndicator(s.mode, e))
                                }
                            }
                            i = l
                        }
                ...
                return {
                    Image: (t = function(t) {
                        ...
                        return n.useEffect(function() {
                            i && i.current && o.toDataURL(e, r, function(t, e) {
                                if (t) throw t;
                                i.current instanceof HTMLImageElement && (i.current.src = e)
                            })
                        }, [e, r, i]), n.createElement("img", {
                            ref: i
                        })
                    }, n.useMemo(function() {
                        return t
                    ...
                    Canvas: (r = function(t) {
                        var e = t.text,
                            ...
                            a = n.useRef(null);
                        return n.useEffect(function() {
                            var t, n, u, l, s, f, c, h, d;
                            if (a && a.current && (o.toCanvas(a.current, e, r, function(t) {
                                    if (t) throw t
                                }), i)) {
                                var g = a.current.getContext("2d");
                                if (g) {
                                    var p = new Image;
                                    p.src = i.src;
                                    var m = (null == (t = null == i ? void 0 : i.options) ? void 0 : t.width) || 30;
                                    if ((null == (n = null == i ? void 0 : i.options) ? void 0 : n.hasOwnProperty("x")) && (null == (u = null == i ? void 0 : i.options) ? void 0 : u.hasOwnProperty("y"))) {
                                        var E = (null == (l = null == i ? void 0 : i.options) ? void 0 : l.x) || 0,
                                            w = (null == (s = null == i ? void 0 : i.options) ? void 0 : s.y) || 0;
                                        p.onload = function() {
                                            g.drawImage(p, E, w, m, m)
                                        }
                                    }
                                    if (!(null == (f = null == i ? void 0 : i.options) ? void 0 : f.hasOwnProperty("x")) || !(null == (c = null == i ? void 0 : i.options) ? void 0 : c.hasOwnProperty("y")) || void 0 === (null == (h = null == i ? void 0 : i.options) ? void 0 : h.x) || void 0 === (null == (d = null == i ? void 0 : i.options) ? void 0 : d.y)) {
                                        var y = null == r ? void 0 : r.margin;
                                        y = y ? 8 * y : 32 * (0 !== y);
                                        var v = (((null == r ? void 0 : r.width) || 116 + y) - m) / 2;
                                        p.onload = function() {
                                            g.drawImage(p, v, v, m, m)
                                        }
                                    }
                                }
                            }
                        }, [a, e, r, i]), n.createElement("canvas", {
                            ref: a
                        })
                    }, n.useMemo(function() {
                        return r
                    ...
                    SVG: (e = function(t) {
                        var e = t.text,
                            ...
                            i = n.useRef(null);
                        return n.useEffect(function() {
                            o.toString(e, r, function(t, e) {
                                if (t) throw t;
                                i.current instanceof HTMLDivElement && (i.current.innerHTML = e)
                            })
            ...
            var e = {
                single_source_shortest_paths: function(t, r, n) {
                    ...
                    for (d.push(r, 0); !d.empty();)
                        for (a in i = (o = d.pop()).value, u = o.cost, l = t[i] || {}) l.hasOwnProperty(a) && (s = u + l[a], f = h[a], (void 0 === h[a] || f > s) && (h[a] = s, d.push(a, s), c[a] = i));
