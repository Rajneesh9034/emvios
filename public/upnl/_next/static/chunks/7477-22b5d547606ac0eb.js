...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [7477], {
        ...
        24473: (e, t, n) => {
            ...
            var d = "undefined" != typeof window ? c.useLayoutEffect : c.useEffect,
                s = new WeakMap;
            ...
            var h = function(e) {
                    void 0 === e && (e = {});
                    var t, n, r, o, c = (t = null, void 0 === n && (n = f), r = [], o = !1, {
                        read: function() {
                ...
                p = c.forwardRef(function(e, t) {
                    var n, r, o, i, u = c.useRef(null),
                        ...
                        N = e.as,
                        R = e.gapMode,
                        L = (0, a.Tt)(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]),
                        x = (n = [u, t], r = function(e) {
                        ...
                        })[0]).callback = r, i = o.facade, d(function() {
                            var e = s.get(i);
                            if (e) {
                                var t = new Set(e),
                                    r = new Set(n),
                        ...
                        T = (0, a.Cl)((0, a.Cl)({}, L), p);
                    return c.createElement(c.Fragment, null, E && c.createElement(k, {
                        sideCar: h,
                        removeScrollBar: b,
                        shards: C,
                        noIsolation: S,
                        ...
                        lockRef: u,
                        gapMode: R
                    }), g ? c.cloneElement(c.Children.only(w), (0, a.Cl)((0, a.Cl)({}, T), {
                        ref: x
                    })) : c.createElement(void 0 === N ? "div" : N, (0, a.Cl)({}, T, {
                        className: y,
                        ref: x
                    }), w))
                });
            ...
            var m = function(e) {
                ...
                return c.createElement(r, (0, a.Cl)({}, n))
            };
            m.isSideCarExport = !0;
            var g = function() {
                    var e = 0,
                    ...
                    return {
                        add: function(r) {
                            if (0 == e && (t = function() {
                                ...
                                var a, c;
                                (a = t).styleSheet ? a.styleSheet.cssText = r : a.appendChild(document.createTextNode(r)), c = t, (document.head || document.getElementsByTagName("head")[0]).appendChild(c)
                            }
                            e++
                        },
                        remove: function() {
                ...
                R = function() {
                    c.useEffect(function() {
                        return document.body.setAttribute(A, (N() + 1).toString()),
                            function() {
                                var e = N() - 1;
                ...
                Y = function(e, t, n, r, o) {
                    ...
                    do {
                        var v = I(e, u),
                            p = v[0],
                            m = v[1] - v[2] - c * p;
                        (p || m) && X(e, u) && (f += m, h += p), u = u instanceof ShadowRoot ? u.host : u.parentNode
                    } while (!l && u !== document.body || l && (t.contains(u) || t === u));
                    return s && (o && 1 > Math.abs(f) || !o && i > f) ? d = !0 : !s && (o && 1 > Math.abs(h) || !o && -i > h) && (d = !0), d
                },
                D = function(e) {
            ...
            let F = (r = function(e) {
                ...
                c.useEffect(function() {
                    ...
                    if (e.inert) {
                        ...
                        var t = (0, a.fX)([e.lockRef.current], (e.shards || []).map(j), !0).filter(Boolean);
                ...
                var l = c.useCallback(function(e, t) {
                    ...
                    d = c.useCallback(function(e) {
                        if (z.length && z[z.length - 1] === i) {
                            ...
                            if (!r) {
                                ...
                                (o.length > 0 ? l(e, o[0]) : !u.current.noIsolation) && e.cancelable && e.preventDefault()
                            }
                        }
                    }, []),
                    s = c.useCallback(function(e, n, r, o) {
                        var a = {
                            name: e,
                            delta: n,
                            target: r,
                    ...
                    v = c.useCallback(function(t) {
                        s(t.type, D(t), t.target, l(t, e.lockRef.current))
                    }, []);
                c.useEffect(function() {
                    return z.push(i), e.setCallbacks({
                            ...
                            onWheelCapture: h,
                            onTouchMoveCapture: v
                        }), document.addEventListener("wheel", d, W), document.addEventListener("touchmove", d, W), document.addEventListener("touchstart", f, W),
                        function() {
                            z = z.filter(function(e) {
                                return e !== i
                            }), document.removeEventListener("wheel", d, W), document.removeEventListener("touchmove", d, W), document.removeEventListener("touchstart", f, W)
                        }
                }, []);
                var p = e.removeScrollBar,
                    m = e.inert;
                return c.createElement(c.Fragment, null, m ? c.createElement(i, {
                    styles: "\n  .block-interactivity-".concat(o, " {pointer-events: none;}\n  .allow-interactivity-").concat(o, " {pointer-events: all;}\n")
                }) : null, p ? c.createElement(L, {
                    gapMode: e.gapMode
                }) : null)
            }, h.useMedium(r), m);
            var q = c.forwardRef(function(e, t) {
                return c.createElement(p, (0, a.Cl)({}, e, {
                    ref: t,
                    sideCar: F
                }))
            });
            ...
            var r = function(e) {
                        ...
                        !e || h.has(e) || Array.prototype.forEach.call(e.children, function(e) {
                            if (f.has(e)) p(e);
                                ...
                                var t = e.getAttribute(r),
                                    ...
                                    i = (o.get(e) || 0) + 1,
                                    u = (d.get(e) || 0) + 1;
                                o.set(e, i), d.set(e, u), s.push(e), 1 === i && c && a.set(e, !0), 1 === u && e.setAttribute(n, "true"), c || e.setAttribute(r, "true")
                            } catch (t) {
                    ...
                    return p(t), f.clear(), i++,
                        function() {
                            s.forEach(function(e) {
                                var t = o.get(e) - 1,
                                    c = d.get(e) - 1;
                                o.set(e, t), d.set(e, c), t || (a.has(e) || e.removeAttribute(r), a.delete(e)), c || e.removeAttribute(n)
                ...
                d = function(e, t, n) {
                    ...
                    var o = Array.from(Array.isArray(e) ? e : [e]),
                        a = t || r(e);
                    return a ? (o.push.apply(o, Array.from(a.querySelectorAll("[aria-live]"))), l(o, a, n, "aria-hidden")) : function() {
                        return null
                    }
                }
        }
