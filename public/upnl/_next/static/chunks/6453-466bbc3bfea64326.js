    ...
    [6453], {
        ...
        46453: (e, t, r) => {
            ...
            var X = !!String.prototype.startsWith && "_a".startsWith("a", 1),
                ...
                z = !0;
            try {
                z = (null == (s = er("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) ? void 0 : s[0]) === "a"
            } catch (e) {
                z = !1
            }
            ...
            var ei = function() {
                ...
                return e.prototype.parse = function() {
                    ...
                    for (var o = []; !this.isEOF();) {
                        ...
                        else if (!r) return this.error(n.UNMATCHED_CLOSING_TAG, V(this.clonePosition(), this.clonePosition()));
                        else break
                    }
                    return {
                        val: o,
                    ...
                    if (this.isEOF() || !eo(this.char())) return this.error(n.INVALID_TAG, V(h, this.clonePosition()));
                    var u = this.clonePosition();
                    return o !== this.parseTagName() ? this.error(n.UNMATCHED_CLOSING_TAG, V(u, this.clonePosition())) : (this.bumpSpace(), this.bumpIf(">")) ? {
                        val: {
                            type: i.tag,
                            value: o,
                            children: a,
                    ...
                    var r = this.clonePosition();
                    if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(n.EXPECT_ARGUMENT_CLOSING_BRACE, V(r, this.clonePosition()));
                    if (125 === this.char()) return this.bump(), this.error(n.EMPTY_ARGUMENT, V(r, this.clonePosition()));
                    var o = this.parseIdentifierIfPossible().value;
                    if (!o) return this.error(n.MALFORMED_ARGUMENT, V(r, this.clonePosition()));
                    if (this.bumpSpace(), this.isEOF()) return this.error(n.EXPECT_ARGUMENT_CLOSING_BRACE, V(r, this.clonePosition()));
                    switch (this.char()) {
                        case 125:
                            return this.bump(), {
                                val: {
                    ...
                    switch (u) {
                        ...
                        case "time":
                            ...
                            if (this.bumpIf(",")) {
                                ...
                                if (m.err) return m;
                                var E = et(m.val);
                                if (0 === E.length) return this.error(n.EXPECT_ARGUMENT_STYLE, V(this.clonePosition(), this.clonePosition()));
                                f = {
                                    style: E,
                            ...
                            if (f && Q(null == f ? void 0 : f.style, "::", 0)) {
                                        ...
                                        if ("j" === i) {
                                            ...
                                            var s = 1 + (1 & o),
                                                ...
                                                h = function(e) {
                                                    ...
                                                    var n = e.language;
                                                    return "root" !== n && (t = e.maximize().region), (D[t || ""] || D[n || ""] || D["".concat(n, "-001")] || D["001"])[0]
                                                }(t);
                                ...
                                var E = {
                                    ...
                                    parsedOptions: this.shouldParseSkeletons ? (T = {}, H.replace(L, function(e) {
                                        var t = e.length;
                                        switch (e[0]) {
                                            case "G":
                        ...
                        case "select":
                            ...
                            if (this.bumpSpace(), !this.bumpIf(",")) return this.error(n.EXPECT_SELECT_ARGUMENT_OPTIONS, V(d, (0, c.Cl)({}, d)));
                            this.bumpSpace();
                            var v = this.parseIdentifierIfPossible(),
                                _ = 0;
                            if ("select" !== u && "offset" === v.value) {
                                if (!this.bumpIf(":")) return this.error(n.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, V(this.clonePosition(), this.clonePosition()));
                                this.bumpSpace();
                                var m = this.tryParseDecimalInteger(n.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, n.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);
                                if (m.err) return m;
                    ...
                    return this.isEOF() || 125 !== this.char() ? this.error(n.EXPECT_ARGUMENT_CLOSING_BRACE, V(e, this.clonePosition())) : (this.bump(), {
                        val: !0,
                        err: null
                    })
                    ...
                    for (var e = 0, t = this.clonePosition(); !this.isEOF();) switch (this.char()) {
                        case 39:
                            this.bump();
                            var r = this.clonePosition();
                            if (!this.bumpUntil("'")) return this.error(n.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, V(r, this.clonePosition()));
                            this.bump();
                            break;
                        case 123:
                            e += 1, this.bump();
                    ...
                    for (var o, s = !1, a = [], h = new Set, u = i.value, l = i.location;;) {
                        ...
                        var p = this.clonePosition();
                        if (!this.bumpIf("{")) return this.error("select" === t ? n.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : n.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, V(this.clonePosition(), this.clonePosition()));
                    ...
                    return 0 === a.length ? this.error("select" === t ? n.EXPECT_SELECT_ARGUMENT_SELECTOR : n.EXPECT_PLURAL_ARGUMENT_SELECTOR, V(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !s ? this.error(n.MISSING_OTHER_CLAUSE, V(this.clonePosition(), this.clonePosition())) : {
                        val: a,
                        err: null
                    }
            ...
            function ea(e, t) {
                ...
                return (null == t ? void 0 : t.captureLocation) || function e(t) {
                    t.forEach(function(t) {
                        ...
                        else H(t) && S(t.style) || (d(t) || v(t)) && N(t.style) ? delete t.style.location : B(t) && e(t.children)
                    })
                }(r.val), r.val
            }! function(e) {
            ...
            var ep = function() {
                function e(t, r, n, o) {
                    ...
                    if (this.formatterCache = {
                            ...
                            return function e(t, r, n, o, s, a, l) {
                                ...
                                for (var c = [], f = 0; f < t.length; f++) {
                                    ...
                                    if (p.type === i.argument) {
                                        E && "string" != typeof E && "number" != typeof E || (E = "string" == typeof E || "number" == typeof E ? String(E) : ""), c.push({
                                    ...
                                    if (d(p)) {
                                        var g = "string" == typeof p.style ? o.date[p.style] : N(p.style) ? p.style.parsedOptions : void 0;
                                        c.push({
                                            type: u.literal,
                                    ...
                                    if (v(p)) {
                                        var g = "string" == typeof p.style ? o.time[p.style] : N(p.style) ? p.style.parsedOptions : o.time.medium;
                                        c.push({
                                            type: u.literal,
                                            value: n.getDateTimeFormat(r, g).format(E)
                                        });
                                    ...
                                    if (H(p)) {
                                        var g = "string" == typeof p.style ? o.number[p.style] : S(p.style) ? p.style.parsedOptions : void 0;
                                        g && g.scale && (E *= g.scale || 1), c.push({
                                            type: u.literal,
                                    ...
                                    if (B(p)) {
                                        ...
                                        var L = I(e(b, r, n, o, s, a).map(function(e) {
                                            return e.value
                                        }));
                                    ...
                                    if (A(p)) {
                                        ...
                                        if (!C) {
                                            if (!Intl.PluralRules) throw new eh('Intl.PluralRules is not available in this environment.\nTry polyfilling it using "@formatjs/intl-pluralrules"\n', h.MISSING_INTL_API, l);
                                            var P = n.getPluralRules(r, {
                                                type: p.pluralType
                                            }).select(E - (p.offset || 0));
                            ...
                            var e;
                            return {
                                locale: (null == (e = l.resolvedLocale) ? void 0 : e.toString()) || Intl.NumberFormat.supportedLocalesOf(l.locales)[0]
                            }
                        ...
                        this.ast = e.__parse(t, (0, c.Cl)((0, c.Cl)({}, m), {
                            locale: this.resolvedLocale
                        }))
                    } else this.ast = t;
                    if (!Array.isArray(this.ast)) throw TypeError("A message must be provided as a String or AST.");
                    this.formats = (s = e.formats, n ? Object.keys(s).reduce(function(e, t) {
                        var r, i;
                        return e[t] = (r = s[t], (i = n[t]) ? (0, c.Cl)((0, c.Cl)((0, c.Cl)({}, r || {}), i || {}), Object.keys(r).reduce(function(e, t) {
                            return e[t] = (0, c.Cl)((0, c.Cl)({}, r[t]), i[t] || {}), e
                        }, {})) : r), e
                    }, (0, c.Cl)({}, s)) : s), this.formatters = o && o.formatters || (void 0 === (a = this.formatterCache) && (a = {
                        number: {},
                        dateTime: {},
                        pluralRules: {}
                    }), {
                        getNumberFormat: f(function() {
                            for (var e, t = [], r = 0; r < arguments.length; r++) t[r] = arguments[r];
            ...
            function eP(e) {
                return function(e, t, r) {
                    let {
                        ...
                        onError: h,
                        timeZone: u
                    } = eI(), c = e["!"], f = "!" === t ? void 0 : t.slice((r + ".").length);
                    return u || eL || !eC || (eL = !0, h(new em(eE.ENVIRONMENT_FALLBACK, void 0))), (0, l.useMemo)(() => (function(e) {
                        ...
                        return function({
                            ...
                            function f(a, f, p) {
                                ...
                                if ("object" == typeof E) {
                                    let e;
                                    return c(a, Array.isArray(E) ? eE.INVALID_MESSAGE : eE.INSUFFICIENT_PATH, e)
                                }
                                let b = (m = E, f ? void 0 : m);
                                if (b) return b;
                                r.getMessageFormat || (r.getMessageFormat = eH((...e) => new ep(e[0], e[1], e[2], {
                                    formatters: r,
                                    ...e[3]
                                }), e.message));
                                try {
                                    g = r.getMessageFormat(E, i, function(e, t, r) {
                                        ...
                                        return r && ["date", "time"].forEach(e => {
                                            let t = s[e];
                                            for (let [e, n] of Object.entries(t)) t[e] = {
                                                timeZone: r,
                                                ...n
                                            }
                                        }), s
                                        ...
                                        formatters: { ...r,
                                            getDateTimeFormat: (e, t) => r.getDateTimeFormat(e, {
                                                timeZone: h,
                                                ...t
                                            })
                                        }
                                ...
                                try {
                                    let e = g.format(f ? function(e) {
                                        ...
                                        return Object.keys(e).forEach(r => {
                                            ...
                                            n = "function" == typeof o ? e => {
                                                let t = o(e);
                                                return (0, l.isValidElement)(t) ? (0, l.cloneElement)(t, {
                                                    key: r + i++
                                                }) : t
                                            } : o, t[r] = n
                                        }), t
                                    ...
                                    return (0, l.isValidElement)(e) || Array.isArray(e) || "string" == typeof e ? e : String(e)
                                } catch (e) {
                            ...
                            return p.rich = f, p.markup = (e, t, r) => f(e, t, r), p.raw = e => {
                                if (u) return n({
                                    error: o,
                                    key: e,
                                    namespace: s
            ...
            function eR() {
                ...
                return (0, l.useMemo)(() => (function(e) {
                    ...
                    function a(e) {
                        return e ? .timeZone || (s ? e = { ...e,
                            timeZone: s
                        } : o(new em(eE.ENVIRONMENT_FALLBACK, void 0))), e
                    }
                    ...
                    function u(e, t, o) {
                        return h(t, o, n ? .dateTime, t => (t = a(t), r.getDateTimeFormat(i, t).format(e)), () => String(e))
                    }
                    ...
                    return {
                        ...
                        number: function(e, t, o) {
                            return h(t, o, n ? .number, t => r.getNumberFormat(i, t).format(e), () => String(e))
                        },
                        relativeTime: function(e, t) {
                            try {
                                var n;
                                let o, s, a = {};
                                t instanceof Date || "number" == typeof t ? o = new Date(t) : t && (o = null != t.now ? new Date(t.now) : l(), s = t.unit, a.style = t.style, a.numberingSystem = t.numberingSystem), o || (o = l());
                                let h = (new Date(e).getTime() - o.getTime()) / 1e3;
                                s || (s = function(e) {
                                    let t = Math.abs(e);
                                    return t < 60 ? "second" : t < 3600 ? "minute" : t < 86400 ? "hour" : t < 604800 ? "day" : t < 2628e3 ? "week" : t < 31536e3 ? "month" : "year"
                        ...
                        list: function(e, t, o) {
                            ...
                            for (let t of e) {
                                let e;
                                "object" == typeof t ? (e = String(u), a.set(e, t)) : e = String(t), s.push(e), u++
                            }
                            return h(t, o, n ? .list, e => {
                                let t = r.getListFormat(i, e).formatToParts(s).map(e => "literal" === e.type ? e.value : a.get(e.value) || e.value);
                                return a.size > 0 ? t : t.join("")
                            }, () => String(e))
                        },
                        dateTimeRange: function(e, t, o, s) {
                            return h(o, s, n ? .dateTime, n => (n = a(n), r.getDateTimeFormat(i, n).formatRange(e, t)), () => [u(e), u(t)].join(" – "))
                        }
                    }
                })({
                    formats: e,
