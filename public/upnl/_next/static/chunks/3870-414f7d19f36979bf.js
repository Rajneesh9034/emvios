    ...
    [3870], {
        ...
        44134: (t, e, r) => {
            ...
            function s(t, e, r) {
                ...
                if (P(t, ArrayBuffer) || t && P(t.buffer, ArrayBuffer) || "undefined" != typeof SharedArrayBuffer && (P(t, SharedArrayBuffer) || t && P(t.buffer, SharedArrayBuffer))) return p(t, e, r);
            ...
            e.Buffer = u, e.SlowBuffer = function(t) {
                ...
                for (r = 0; r < t.length; ++r) {
                    let e = t[r];
                    if (P(e, Uint8Array)) i + e.length > n.length ? (u.isBuffer(e) || (e = u.from(e)), e.copy(n, i)) : Uint8Array.prototype.set.call(n, e, i);
                ...
                for (;;) switch (n) {
                    ...
                    case "utf8":
                    case "utf-8":
                        return i = e, o = r, N(M(t, this.length - i), this, i, o);
                    case "ascii":
                    case "latin1":
                    case "binary":
                ...
                let e = this[t],
                    r = this[t + 7];
                return (void 0 === e || void 0 === r) && _(t, this.length - 8), (BigInt(this[t + 4] + 256 * this[t + 5] + 65536 * this[t + 6] + (r << 24)) << BigInt(32)) + BigInt(e + 256 * this[++t] + 65536 * this[++t] + 0x1000000 * this[++t])
            }), u.prototype.readBigInt64BE = j(function(t) {
                S(t >>>= 0, "offset");
                let e = this[t],
                    r = this[t + 7];
                return (void 0 === e || void 0 === r) && _(t, this.length - 8), (BigInt((e << 24) + 65536 * this[++t] + 256 * this[++t] + this[++t]) << BigInt(32)) + BigInt(0x1000000 * this[++t] + 65536 * this[++t] + 256 * this[++t] + r)
            ...
            function L(t, e, r, n, i, o) {
                ...
                S(i, "offset"), (void 0 === n[i] || void 0 === n[i + o]) && _(i, n.length - (o + 1))
            }
            ...
            function _(t, e, r) {
                if (Math.floor(t) !== t) throw S(t, r), new x.ERR_OUT_OF_RANGE(r || "offset", "an integer", t);
