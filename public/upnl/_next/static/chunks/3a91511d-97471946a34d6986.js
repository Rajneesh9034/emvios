...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [8956], {
        23570: (e, t, r) => {
            ...
            function v(e) {
                try {
                    return a.ev.ExtendedPoint.fromHex(e), !0
                } catch {
                    return !1
                }
            }
            let _ = (e, t) => a.ev.sign(e, t.slice(0, 32)),
                A = a.ev.verify,
                B = e => n.Buffer.isBuffer(e) ? e : e instanceof Uint8Array ? n.Buffer.from(e.buffer, e.byteOffset, e.byteLength) : n.Buffer.from(e);
            class W {
                constructor(e) {
                    Object.assign(this, e)
                }
                encode() {
                    return n.Buffer.from((0, h.serialize)(x, this))
                }
                static decode(e) {
                    return (0, h.deserialize)(x, this, e)
                }
                static decodeUnchecked(e) {
                    return (0, h.deserializeUnchecked)(x, this, e)
                }
            }
            let x = new Map,
                P = 1;
            class E extends W {
                ...
                static isOnCurve(e) {
                    return v(new E(e).toBytes())
                }
            }
            E.default = new E("11111111111111111111111111111111"), x.set(E, {
                kind: "struct",
                fields: [
                    ["_bn", "u256"]
                ]
            }), new E("BPFLoader1111111111111111111111111111111111");
            ...
            let L = (e = "publicKey") => g.av(32, e),
                q = (e = "signature") => g.av(64, e),
                K = (e = "string") => {
                    ...
                    }, t, r), t.alloc = e => g.DH().span + g.DH().span + n.Buffer.from(e, "utf8").length, t
                };
            ...
            class j {
                ...
                getMessageComponents() {
                    ...
                    R(e.length <= 256, "Max static account keys length exceeded");
                    let t = e.filter(([, e]) => e.isSigner && e.isWritable),
                        ...
                        R(t.length > 0, "Expected at least one writable signer key");
                        let [e] = t[0];
                        R(e === this.payer.toBase58(), "Expected first writable signer key to be the fee payer")
                    }
                    return [n, [...t.map(([e]) => new E(e)), ...r.map(([e]) => new E(e)), ...i.map(([e]) => new E(e)), ...s.map(([e]) => new E(e))]]
                }
                ...
                drainKeysFoundInLookupTable(e, t) {
                    ...
                    for (let [s, n] of this.keyMetaMap.entries())
                        if (t(n)) {
                            ...
                            n >= 0 && (R(n < 256, "Max lookup table index exceeded"), r.push(n), i.push(t), this.keyMetaMap.delete(s))
                        }
                    return [r, i]
                }
            }
            let H = "Reached end of buffer unexpectedly";

            function D(e) {
                if (0 === e.length) throw Error(H);
                return e.shift()
            }

            function M(e, ...t) {
                let [r] = t;
                if (2 === t.length ? r + (t[1] ? ? 0) > e.length : r >= e.length) throw Error(H);
                return e.splice(...t)
            }
            class U {
                constructor(e) {
                    this.header = void 0, this.accountKeys = void 0, this.recentBlockhash = void 0, this.instructions = void 0, this.indexToProgramIds = new Map, this.header = e.header, this.accountKeys = e.accountKeys.map(e => new E(e)), this.recentBlockhash = e.recentBlockhash, this.instructions = e.instructions, this.instructions.forEach(e => this.indexToProgramIds.set(e.programIdIndex, this.accountKeys[e.programIdIndex]))
                }
                get version() {
                    return "legacy"
                }
                ...
                getAccountKeys() {
                    return new O(this.staticAccountKeys)
                }
                static compile(e) {
                    let [t, r] = j.compile(e.instructions, e.payerKey).getMessageComponents(), i = new O(r).compileInstructions(e.instructions).map(e => ({
                        programIdIndex: e.programIdIndex,
                ...
                serialize() {
                    ...
                    let r = this.instructions.map(e => {
                            let {
                                accounts: t,
                                programIdIndex: r
                            } = e, i = Array.from(u().decode(e.data)), s = [];
                            Y(s, t.length);
                            let a = [];
                            return Y(a, i.length), {
                                programIdIndex: r,
                    ...
                    let o = g.w3([g.av(1, "numRequiredSignatures"), g.av(1, "numReadonlySignedAccounts"), g.av(1, "numReadonlyUnsignedAccounts"), g.av(t.length, "keyCount"), g.O6(L("key"), e, "keys"), L("recentBlockhash")]),
                        c = {
                ...
                static from(e) {
                    ...
                    return new U({
                        ...
                        recentBlockhash: u().encode(n.Buffer.from(c)),
                        accountKeys: o,
                        instructions: d
                    })
                }
            ...
            class $ {
                ...
                getAccountKeys(e) {
                    ...
                    return new O(this.staticAccountKeys, t)
                }
                isAccountSigner(e) {
                    return e < this.header.numRequiredSignatures
                }
                ...
                static compile(e) {
                    ...
                    let [s, n] = t.getMessageComponents(), a = new O(n, i).compileInstructions(e.instructions);
                    return new $({
                        header: s,
                        staticAccountKeys: n,
                        recentBlockhash: e.recentBlockhash,
                ...
                serialize() {
                    ...
                    let i = this.serializeAddressTableLookups(),
                        s = [];
                    Y(s, this.addressTableLookups.length);
                ...
                serializeInstructions() {
                    ...
                    for (let r of this.compiledInstructions) {
                        let i = [];
                        Y(i, r.accountKeyIndexes.length);
                        let s = [];
                        Y(s, r.data.length);
                ...
                serializeAddressTableLookups() {
                    ...
                    for (let r of this.addressTableLookups) {
                        let i = [];
                        Y(i, r.writableIndexes.length);
                        let s = [];
                        Y(s, r.readonlyIndexes.length);
                        let n = g.w3([L("accountKey"), g.av(i.length, "encodedWritableIndexesLength"), g.O6(g.u8(), r.writableIndexes.length, "writableIndexes"), g.av(s.length, "encodedReadonlyIndexesLength"), g.O6(g.u8(), r.readonlyIndexes.length, "readonlyIndexes")]);
                        e += n.encode({
                ...
                static deserialize(e) {
                    let t = [...e],
                        r = D(t),
                        i = 127 & r;
                    R(r !== i, "Expected versioned message but received legacy message"), R(0 === i, `Expected versioned message with version 0 but found version ${i}`);
                    let s = {
                            numRequiredSignatures: D(t),
                            numReadonlySignedAccounts: D(t),
                            numReadonlyUnsignedAccounts: D(t)
                        },
                        n = [],
                        a = z(t);
                    for (let e = 0; e < a; e++) n.push(new E(M(t, 0, 32)));
                    let o = u().encode(M(t, 0, 32)),
                        c = z(t),
                        l = [];
                    for (let e = 0; e < c; e++) {
                        let e = D(t),
            ...
            let F = {
                    ...
                    deserialize: e => {
                        let t = F.deserializeMessageVersion(e);
                        if ("legacy" === t) return U.from(e);
                        if (0 === t) return $.deserialize(e);
            ...
            class X {
                ...
                add(...e) {
                    ...
                    return e.forEach(e => {
                        "instructions" in e ? this.instructions = this.instructions.concat(e.instructions) : "data" in e && "programId" in e && "keys" in e ? this.instructions.push(e) : this.instructions.push(new G(e))
                    }), this
                }
                compileMessage() {
                    let e, t, r;
                    ...
                    n.forEach(({
                        ...
                        t ? (d.push(e.toString()), o += 1, r || (c += 1)) : (h.push(e.toString()), r || (l += 1))
                    });
                    let g = d.concat(h),
                        p = t.map(e => {
                            let {
                    ...
                    return p.forEach(e => {
                        R(e.programIdIndex >= 0), e.accounts.forEach(e => R(e >= 0))
                    }), new U({
                        header: {
                ...
                _getMessageSignednessErrors(e, t) {
                    ...
                    for (let {
                            signature: i,
                            publicKey: s
                        } of this.signatures) null === i ? t && (r.missing || = []).push(s) : A(i, e, s.toBytes()) || (r.invalid || = []).push(s);
...
Missing signature for public key${1===e.missing.length?"":"(s)"} [\`${e.missing.map(e=>e.toBase58()).join("`, `")}\`].`), Error(t)
                ...
                _serialize(e) {
                    ...
                    let i = r.length + 64 * t.length + e.length,
                        s = n.Buffer.alloc(i);
                    return R(t.length < 256), n.Buffer.from(r).copy(s, 0), t.forEach(({
                        signature: e
                    }, t) => {
                        null !== e && (R(64 === e.length, "signature has invalid length"), n.Buffer.from(e).copy(s, r.length + 64 * t))
                    }), e.copy(s, r.length + 64 * t.length), R(s.length <= 1232, `Transaction too large: ${s.length} > 1232`), s
                }
                get keys() {
                    return R(1 === this.instructions.length), this.instructions[0].keys.map(e => e.pubkey)
                }
                get programId() {
                    return R(1 === this.instructions.length), this.instructions[0].programId
                }
                get data() {
                    return R(1 === this.instructions.length), this.instructions[0].data
                }
                static from(e) {
                    let t = [...e],
                        r = z(t),
            ...
            class Z {
                ...
                static decompile(e, t) {
                    ...
                    R(c > 0, "Message header is invalid");
                    let l = e.staticAccountKeys.length - n - o;
                    R(l >= 0, "Message header is invalid");
            ...
            class Q {
                ...
                constructor(e, t) {
                    if (this.signatures = void 0, this.message = void 0, void 0 !== t) R(t.length === e.header.numRequiredSignatures, "Expected signatures length to be equal to the number of required signatures"), this.signatures = t;
                    else {
                        let t = [];
                ...
                serialize() {
                    ...
                    let r = g.w3([g.av(t.length, "encodedSignaturesLength"), g.O6(q(), this.signatures.length, "signatures"), g.av(e.length, "serializedMessage")]),
                ...
                static deserialize(e) {
                    let t = [...e],
                        r = [],
                        i = z(t);
                    for (let e = 0; e < i; e++) r.push(new Uint8Array(M(t, 0, 64)));
                    return new Q(F.deserialize(new Uint8Array(t)), r)
                }
                sign(e) {
                    ...
                    for (let i of e) {
                        ...
                        R(e >= 0, `Cannot sign with non signer key ${i.publicKey.toBase58()}`), this.signatures[e] = _(t, i.secretKey)
                    }
                }
                addSignature(e, t) {
                    R(64 === t.byteLength, "Signature must be 64 bytes long");
                    let r = this.message.staticAccountKeys.slice(0, this.message.header.numRequiredSignatures).findIndex(t => t.equals(e));
                    R(r >= 0, `Can not add signature; \`${e.toBase58()}\` is not required to sign this transaction`), this.signatures[r] = t
                }
            }
            let ee = new E("SysvarC1ock11111111111111111111111111111111");
            new E("SysvarEpochSchedu1e111111111111111111111111"), new E("Sysvar1nstructions1111111111111111111111111");
            let et = new E("SysvarRecentB1ockHashes11111111111111111111"),
                er = new E("SysvarRent111111111111111111111111111111111");
            new E("SysvarRewards111111111111111111111111111111"), new E("SysvarS1otHashes111111111111111111111111111"), new E("SysvarS1otHistory11111111111111111111111111");
            let ei = new E("SysvarStakeHistory1111111111111111111111111");
...
` + n + a;
            ...
            let el = g.I0("lamportsPerSignature"),
                eu = g.w3([g.DH("version"), g.DH("state"), L("authorizedPubkey"), L("nonce"), g.w3([el], "feeCalculator")]),
                ed = eu.span;
            class eh {
                constructor(e) {
                ...
                static fromAccountData(e) {
                    let t = eu.decode(B(e), 0);
                    return new eh({
                        authorizedPubkey: new E(t.authorizedPubkey),
                        nonce: new E(t.nonce).toString(),
            ...
            function eg(e) {
                ...
                return t.decode = (e, t) => {
                    let i = r(e, t);
                    return s.decode(i)
                }, t.encode = (e, t, r) => i(s.encode(e), t, r), t
            }
            let ep = Object.freeze({
                Create: {
                    index: 0,
                    layout: g.w3([g.DH("instruction"), g.Wg("lamports"), g.Wg("space"), L("programId")])
                },
                Assign: {
                    index: 1,
                    layout: g.w3([g.DH("instruction"), L("programId")])
                },
                Transfer: {
                    index: 2,
                    layout: g.w3([g.DH("instruction"), eg("lamports")])
                },
                CreateWithSeed: {
                    index: 3,
                    layout: g.w3([g.DH("instruction"), L("base"), K("seed"), g.Wg("lamports"), g.Wg("space"), L("programId")])
                },
                AdvanceNonceAccount: {
                    index: 4,
                ...
                InitializeNonceAccount: {
                    index: 6,
                    layout: g.w3([g.DH("instruction"), L("authorized")])
                },
                ...
                AllocateWithSeed: {
                    index: 9,
                    layout: g.w3([g.DH("instruction"), L("base"), K("seed"), g.Wg("space"), L("programId")])
                },
                AssignWithSeed: {
                    index: 10,
                    layout: g.w3([g.DH("instruction"), L("base"), K("seed"), L("programId")])
                },
                TransferWithSeed: {
                    index: 11,
                    layout: g.w3([g.DH("instruction"), eg("lamports"), K("seed"), L("programId")])
                },
                UpgradeNonceAccount: {
                    index: 12,
                    layout: g.w3([g.DH("instruction")])
            ...
            class em {
                ...
                static transfer(e) {
                    let t, r;
                    return "basePubkey" in e ? (t = ec(ep.TransferWithSeed, {
                ...
                static assign(e) {
                    let t, r;
                    return "basePubkey" in e ? (t = ec(ep.AssignWithSeed, {
                ...
                static nonceWithdraw(e) {
                    let t = ec(ep.WithdrawNonceAccount, {
                        lamports: e.lamports
                    });
                    return new G({
                        keys: [{
                ...
                static allocate(e) {
                    let t, r;
                    return "basePubkey" in e ? (t = ec(ep.AllocateWithSeed, {
                        base: B(e.basePubkey.toBuffer()),
                        seed: e.seed,
                        space: e.space,
                        programId: B(e.programId.toBuffer())
            ...
            em.programId = new E("11111111111111111111111111111111");
            class ef {
                constructor() {}
                ...
                static async load(e, t, r, i, s) {
                    {
                        ...
                        if (null !== a) {
                            ...
                            a.data.length !== s.length && (o = o || new X).add(em.allocate({
                                accountPubkey: r.publicKey,
                                space: s.length
                            })), a.owner.equals(i) || (o = o || new X).add(em.assign({
                                accountPubkey: r.publicKey,
                                programId: i
                            })), a.lamports < n && (o = o || new X).add(em.transfer({
                                fromPubkey: t.publicKey,
                                toPubkey: r.publicKey,
                                lamports: n - a.lamports
                            }))
                        } else o = new X().add(em.createAccount({
                            fromPubkey: t.publicKey,
                    ...
                    for (; l.length > 0;) {
                        ...
                        u.push(ea(e, h, [t, r], {
                            commitment: "confirmed"
                        })), e._rpcEndpoint.includes("solana.com") && await eo(250), c += o, l = l.slice(o)
                    }
                    await Promise.all(u); {
            ...
            ef.chunkSize = 932, new E("BPFLoader2111111111111111111111111111111111");
            var eb = function(e) {
            ...
            class ew {
                ...
                getEpochAndSlotIndex(e) {
                    if (e < this.firstNormalSlot) {
                        var t;
                        let r = ey(0 === (t = e + 32 + 1) ? 1 : (t--, t |= t >> 1, t |= t >> 2, t |= t >> 4, t |= t >> 8, t |= t >> 16, (t |= t >> 32) + 1)) - ey(32) - 1,
                ...
                getSlotsInEpoch(e) {
                    return e < this.firstNormalEpoch ? Math.pow(2, e + ey(32)) : this.slotsPerEpoch
                }
            }
            var ek = globalThis.fetch;
            class eS extends y.vE {
                constructor(e, t, r) {
                    super(e => {
                        let r = (0, y.kb)(e, {
                            autoconnect: !0,
            ...
            class eI {
                ...
                static deserialize(e) {
                    let t = function(e, t) {
                        ...
                        r = e.length - 56;
                    R(r >= 0, "lookup table is invalid"), R(r % 32 == 0, "lookup table is invalid");
                    let {
                        addresses: i
                    } = g.w3([g.O6(L(), r / 32, "addresses")]).decode(e.slice(56));
                    return {
                        ...
                        authority: 0 !== t.authority.length ? new E(t.authority[0]) : void 0,
                        addresses: i.map(e => new E(e))
                    }
                }
            }
            let ev = {
                    index: 1,
                    layout: g.w3([g.DH("typeIndex"), eg("deactivationSlot"), g.I0("lastExtendedSlot"), g.u8("lastExtendedStartIndex"), g.u8(), g.O6(L(), g.cY(g.u8(), -1), "authority")])
                },
                e_ = /^[^:]+:\/\/([^:[]+|\[[^\]]+\])(:\d+)?(.*)/i,
                eA = (0, m.au)((0, m.KJ)(E), (0, m.Yj)(), e => new E(e)),
                eB = (0, m.PV)([(0, m.Yj)(), (0, m.eu)("base64")]),
                eW = (0, m.au)((0, m.KJ)(n.Buffer), eB, e => n.Buffer.from(e[0], "base64"));
            ...
            function eC(e) {
                return (0, m.au)(eE(e), eN, t => "error" in t ? t : { ...t,
                    result: (0, m.vt)(t.result, e)
                })
            }
            ...
            function eL(e, t) {
                return 0 === e ? new $({
                    header: t.header,
                    staticAccountKeys: t.accountKeys.map(e => new E(e)),
            ...
            let eq = (0, m.NW)({
                    foundation: (0, m.ai)(),
                    foundationTerm: (0, m.ai)(),
                    initial: (0, m.ai)(),
                    taper: (0, m.ai)(),
                    terminal: (0, m.ai)()
                }),
                eK = eC((0, m.YO)((0, m.me)((0, m.NW)({
                    epoch: (0, m.ai)(),
                    effectiveSlot: (0, m.ai)(),
                    amount: (0, m.ai)(),
                    postBalance: (0, m.ai)(),
                    commission: (0, m.lq)((0, m.me)((0, m.ai)()))
                })))),
                ez = (0, m.YO)((0, m.NW)({
                    slot: (0, m.ai)(),
                    prioritizationFee: (0, m.ai)()
                })),
                eY = (0, m.NW)({
                    total: (0, m.ai)(),
                    validator: (0, m.ai)(),
                ...
                eR = (0, m.NW)({
                    ...
                    slotsInEpoch: (0, m.ai)(),
                    absoluteSlot: (0, m.ai)(),
                    blockHeight: (0, m.lq)((0, m.ai)()),
                    transactionCount: (0, m.lq)((0, m.ai)())
                }),
                ej = (0, m.NW)({
                    slotsPerEpoch: (0, m.ai)(),
                    leaderScheduleSlotOffset: (0, m.ai)(),
                    warmup: (0, m.zM)(),
                    firstNormalEpoch: (0, m.ai)(),
                    firstNormalSlot: (0, m.ai)()
                }),
                eH = (0, m.g1)((0, m.Yj)(), (0, m.YO)((0, m.ai)())),
                eD = (0, m.me)((0, m.KC)([(0, m.NW)({}), (0, m.Yj)()])),
                eM = (0, m.NW)({
                    err: eD
                }),
                eU = (0, m.eu)("receivedSignature"),
                e$ = (0, m.NW)({
                    "solana-core": (0, m.Yj)(),
                    "feature-set": (0, m.lq)((0, m.ai)())
                }),
                eF = (0, m.NW)({
                    program: (0, m.Yj)(),
                    programId: eA,
                ...
                eJ = eT((0, m.NW)({
                    err: (0, m.me)((0, m.KC)([(0, m.NW)({}), (0, m.Yj)()])),
                    logs: (0, m.me)((0, m.YO)((0, m.Yj)())),
                    accounts: (0, m.lq)((0, m.me)((0, m.YO)((0, m.me)((0, m.NW)({
                        executable: (0, m.zM)(),
                        owner: (0, m.Yj)(),
                        lamports: (0, m.ai)(),
                        data: (0, m.YO)((0, m.Yj)()),
                        rentEpoch: (0, m.lq)((0, m.ai)())
                    }))))),
                    unitsConsumed: (0, m.lq)((0, m.ai)()),
                    returnData: (0, m.lq)((0, m.me)((0, m.NW)({
                        programId: (0, m.Yj)(),
                        data: (0, m.PV)([(0, m.Yj)(), (0, m.eu)("base64")])
                    }))),
                    innerInstructions: (0, m.lq)((0, m.me)((0, m.YO)((0, m.NW)({
                        index: (0, m.ai)(),
                        instructions: (0, m.YO)((0, m.KC)([eF, eV]))
                    }))))
                })),
                eG = eT((0, m.NW)({
                    byIdentity: (0, m.g1)((0, m.Yj)(), (0, m.YO)((0, m.ai)())),
                    range: (0, m.NW)({
                        firstSlot: (0, m.ai)(),
                        lastSlot: (0, m.ai)()
                    })
                ...
                e2 = eT((0, m.NW)({
                    total: (0, m.ai)(),
                    circulating: (0, m.ai)(),
                    nonCirculating: (0, m.ai)(),
                    nonCirculatingAccounts: (0, m.YO)(eA)
                })),
                e5 = (0, m.NW)({
                    amount: (0, m.Yj)(),
                    uiAmount: (0, m.me)((0, m.ai)()),
                    decimals: (0, m.ai)(),
                    uiAmountString: (0, m.lq)((0, m.Yj)())
                }),
                e6 = eT((0, m.YO)((0, m.NW)({
                    address: eA,
                    amount: (0, m.Yj)(),
                ...
                ti = (0, m.au)((0, m.KC)([(0, m.KJ)(n.Buffer), e7]), (0, m.KC)([eB, e7]), e => Array.isArray(e) ? (0, m.vt)(e, eW) : e),
                ts = (0, m.NW)({
                    executable: (0, m.zM)(),
                    owner: eA,
                    lamports: (0, m.ai)(),
                ...
                ta = (0, m.NW)({
                    state: (0, m.KC)([(0, m.eu)("active"), (0, m.eu)("inactive"), (0, m.eu)("activating"), (0, m.eu)("deactivating")]),
                    active: (0, m.ai)(),
                    inactive: (0, m.ai)()
                }),
                to = eC((0, m.YO)((0, m.NW)({
                    ...
                    err: eD,
                    memo: (0, m.me)((0, m.Yj)()),
                    blockTime: (0, m.lq)((0, m.me)((0, m.ai)()))
                }))),
                tc = eC((0, m.YO)((0, m.NW)({
                    signature: (0, m.Yj)(),
                    slot: (0, m.ai)(),
                ...
                tp = (0, m.KC)([(0, m.NW)({
                    type: (0, m.KC)([(0, m.eu)("firstShredReceived"), (0, m.eu)("completed"), (0, m.eu)("optimisticConfirmation"), (0, m.eu)("root")]),
                    slot: (0, m.ai)(),
                    timestamp: (0, m.ai)()
                }), (0, m.NW)({
                    type: (0, m.eu)("createdBank"),
                    parent: (0, m.ai)(),
                    slot: (0, m.ai)(),
                    timestamp: (0, m.ai)()
                }), (0, m.NW)({
                    ...
                    timestamp: (0, m.ai)(),
                    stats: (0, m.NW)({
                        numTransactionEntries: (0, m.ai)(),
                        numSuccessfulTransactions: (0, m.ai)(),
                        numFailedTransactions: (0, m.ai)(),
                        maxTransactionsPerEntry: (0, m.ai)()
                    })
                }), (0, m.NW)({
                    type: (0, m.eu)("dead"),
                    slot: (0, m.ai)(),
                ...
                ty = (0, m.NW)({
                    pubkey: (0, m.Yj)(),
                    gossip: (0, m.me)((0, m.Yj)()),
                    tpu: (0, m.me)((0, m.Yj)()),
                    rpc: (0, m.me)((0, m.Yj)()),
                    version: (0, m.me)((0, m.Yj)())
                }),
                tw = (0, m.NW)({
                    votePubkey: (0, m.Yj)(),
                    nodePubkey: (0, m.Yj)(),
                    activatedStake: (0, m.ai)(),
                    epochVoteAccount: (0, m.zM)(),
                    epochCredits: (0, m.YO)((0, m.PV)([(0, m.ai)(), (0, m.ai)(), (0, m.ai)()])),
                    commission: (0, m.ai)(),
                    lastVote: (0, m.ai)(),
                    rootSlot: (0, m.me)((0, m.ai)())
                }),
                tk = eC((0, m.NW)({
                    current: (0, m.YO)(tw),
                    delinquent: (0, m.YO)(tw)
                })),
                tS = (0, m.KC)([(0, m.eu)("processed"), (0, m.eu)("confirmed"), (0, m.eu)("finalized")]),
                tI = (0, m.NW)({
                    slot: (0, m.ai)(),
                    confirmations: (0, m.me)((0, m.ai)()),
                    err: eD,
                    confirmationStatus: (0, m.lq)(tS)
                }),
                tv = eT((0, m.YO)((0, m.me)(tI))),
                t_ = eC((0, m.ai)()),
                tA = (0, m.NW)({
                    accountKey: eA,
                    writableIndexes: (0, m.YO)((0, m.ai)()),
                    readonlyIndexes: (0, m.YO)((0, m.ai)())
                }),
                tB = (0, m.NW)({
                    signatures: (0, m.YO)((0, m.Yj)()),
                    message: (0, m.NW)({
                        accountKeys: (0, m.YO)((0, m.Yj)()),
                        header: (0, m.NW)({
                            numRequiredSignatures: (0, m.ai)(),
                            numReadonlySignedAccounts: (0, m.ai)(),
                            numReadonlyUnsignedAccounts: (0, m.ai)()
                        }),
                        instructions: (0, m.YO)((0, m.NW)({
                            accounts: (0, m.YO)((0, m.ai)()),
                            data: (0, m.Yj)(),
                            programIdIndex: (0, m.ai)()
                        })),
                        recentBlockhash: (0, m.Yj)(),
                        addressTableLookups: (0, m.lq)((0, m.YO)(tA))
                    })
                }),
                tW = (0, m.NW)({
                    pubkey: eA,
                    signer: (0, m.zM)(),
                    writable: (0, m.zM)(),
                    source: (0, m.lq)((0, m.KC)([(0, m.eu)("transaction"), (0, m.eu)("lookupTable")]))
                }),
                tx = (0, m.NW)({
                    accountKeys: (0, m.YO)(tW),
                    signatures: (0, m.YO)((0, m.Yj)())
                }),
                tP = (0, m.NW)({
                    parsed: (0, m.L5)(),
                ...
                tC = (0, m.KC)([(0, m.NW)({
                    ...
                    accounts: (0, m.YO)((0, m.Yj)()),
                    data: (0, m.Yj)(),
                    programId: (0, m.Yj)()
                })]),
                tT = (0, m.au)(tN, tC, e => "accounts" in e ? (0, m.vt)(e, tE) : (0, m.vt)(e, tP)),
                tO = (0, m.NW)({
                    signatures: (0, m.YO)((0, m.Yj)()),
                    message: (0, m.NW)({
                        accountKeys: (0, m.YO)(tW),
                        instructions: (0, m.YO)(tT),
                        recentBlockhash: (0, m.Yj)(),
                        addressTableLookups: (0, m.lq)((0, m.me)((0, m.YO)(tA)))
                    })
                }),
                tL = (0, m.NW)({
                    accountIndex: (0, m.ai)(),
                ...
                tK = (0, m.NW)({
                    ...
                    preBalances: (0, m.YO)((0, m.ai)()),
                    postBalances: (0, m.YO)((0, m.ai)()),
                    logMessages: (0, m.lq)((0, m.me)((0, m.YO)((0, m.Yj)()))),
                    preTokenBalances: (0, m.lq)((0, m.me)((0, m.YO)(tL))),
                    postTokenBalances: (0, m.lq)((0, m.me)((0, m.YO)(tL))),
                    loadedAddresses: (0, m.lq)(tq),
                    computeUnitsConsumed: (0, m.lq)((0, m.ai)()),
                    costUnits: (0, m.lq)((0, m.ai)())
                }),
                tz = (0, m.NW)({
                    err: eD,
                    fee: (0, m.ai)(),
                ...
                tY = (0, m.KC)([(0, m.eu)(0), (0, m.eu)("legacy")]),
                tR = (0, m.NW)({
                    pubkey: (0, m.Yj)(),
                    lamports: (0, m.ai)(),
                    postBalance: (0, m.me)((0, m.ai)()),
                    rewardType: (0, m.me)((0, m.Yj)()),
                    commission: (0, m.lq)((0, m.me)((0, m.ai)()))
                }),
                tj = eC((0, m.me)((0, m.NW)({
                    blockhash: (0, m.Yj)(),
                    previousBlockhash: (0, m.Yj)(),
                    parentSlot: (0, m.ai)(),
                    transactions: (0, m.YO)((0, m.NW)({
                        transaction: tB,
                        meta: (0, m.me)(tK),
                        version: (0, m.lq)(tY)
                    })),
                    rewards: (0, m.lq)((0, m.YO)(tR)),
                    blockTime: (0, m.me)((0, m.ai)()),
                    blockHeight: (0, m.me)((0, m.ai)())
                }))),
                tH = eC((0, m.me)((0, m.NW)({
                    blockhash: (0, m.Yj)(),
                    previousBlockhash: (0, m.Yj)(),
                ...
                tX = eT((0, m.NW)({
                    blockhash: (0, m.Yj)(),
                    lastValidBlockHeight: (0, m.ai)()
                })),
                tZ = eT((0, m.zM)()),
                tQ = (0, m.NW)({
                    slot: (0, m.ai)(),
                    numTransactions: (0, m.ai)(),
                    numSlots: (0, m.ai)(),
                    samplePeriodSecs: (0, m.ai)()
                }),
                t0 = eC((0, m.YO)(tQ)),
                t1 = eT((0, m.me)((0, m.NW)({
                    feeCalculator: (0, m.NW)({
                        lamportsPerSignature: (0, m.ai)()
                    })
                }))),
                t8 = eC((0, m.Yj)()),
                t3 = eC((0, m.Yj)()),
            ...
            class t4 {
                constructor(e, t) {
                    ...
                    this._commitment = void 0, this._confirmTransactionInitialTimeout = void 0, this._rpcEndpoint = void 0, this._rpcWsEndpoint = void 0, this._rpcClient = void 0, this._rpcRequest = void 0, this._rpcBatchRequest = void 0, this._rpcWebSocket = void 0, this._rpcWebSocketConnected = !1, this._rpcWebSocketHeartbeat = null, this._rpcWebSocketIdleTimeout = null, this._rpcWebSocketGeneration = 0, this._disableBlockhashCaching = !1, this._pollingBlockhash = !1, this._blockhashInfo = {
                        ...
                        return async t => {
                            let {
                                commitment: r,
                                config: i
                            } = ex(t), s = this._buildArgs([], r, void 0, i), n = eb(s);
                            return e[n] = e[n] ? ? (async () => {
                                try {
                                    let e = await this._rpcRequest("getBlockHeight", s),
                                        t = (0, m.vt)(e, eC((0, m.ai)()));
                                    if ("error" in t) throw new en(t.error, "failed to get block height information");
                                    return t.result
                                } finally {
                                    delete e[n]
                                }
                        ...
                        return null != n && console.warn("You have supplied an `httpAgent` when creating a `Connection` in a browser environment.It has been ignored; `httpAgent` is only used in Node environments."), i && (o = async (e, t) => {
                            ...
                            try {
                                let t, r = 5,
                                    a = 500;
                                for (;
                                    (t = o ? await o(e, n) : await c(e, n), 429 === t.status && !0 !== s) && (r -= 1, 0 !== r);) {;
                                    console.error(`Server responded with ${t.status} ${t.statusText}.  Retrying after ${a}ms delay...`), await eo(a), a *= 2
                                }
                                let l = await t.text();
                    ...
                    }(this._rpcClient), this._rpcWebSocket = new eS(this._rpcWsEndpoint, {
                        autoconnect: !1,
                        max_reconnects: 1 / 0
                ...
                async getBalanceAndContext(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = ex(t), s = this._buildArgs([e.toBase58()], r, void 0, i), n = await this._rpcRequest("getBalance", s), a = (0, m.vt)(n, eT((0, m.ai)()));
                    if ("error" in a) throw new en(a.error, `failed to get balance for ${e.toBase58()}`);
                    return a.result
                }
                ...
                async getBlockTime(e) {
                    let t = await this._rpcRequest("getBlockTime", [e]),
                        r = (0, m.vt)(t, eC((0, m.me)((0, m.ai)())));
                    if ("error" in r) throw new en(r.error, `failed to get block time for slot ${e}`);
                    return r.result
                }
                async getMinimumLedgerSlot() {
                    let e = await this._rpcRequest("minimumLedgerSlot", []),
                        t = (0, m.vt)(e, eC((0, m.ai)()));
                    if ("error" in t) throw new en(t.error, "failed to get minimum ledger slot");
                    return t.result
                }
                async getFirstAvailableBlock() {
                    let e = await this._rpcRequest("getFirstAvailableBlock", []),
                        t = (0, m.vt)(e, e3);
                    if ("error" in t) throw new en(t.error, "failed to get first available block");
                    return t.result
                }
                async getSupply(e) {
                    let t = {};
                ...
                async getTokenAccountBalance(e, t) {
                    let r = this._buildArgs([e.toBase58()], t),
                        ...
                        s = (0, m.vt)(i, eT(e5));
                    if ("error" in s) throw new en(s.error, "failed to get token account balance");
                    return s.result
                }
                async getTokenAccountsByOwner(e, t, r) {
                    ...
                    let a = this._buildArgs(n, i, "base64", s),
                        ...
                        c = (0, m.vt)(o, e4);
                    if ("error" in c) throw new en(c.error, `failed to get token accounts owned by account ${e.toBase58()}`);
                    return c.result
                }
                async getParsedTokenAccountsByOwner(e, t, r) {
                    ...
                    let s = this._buildArgs(i, r, "jsonParsed"),
                        ...
                        a = (0, m.vt)(n, e9);
                    if ("error" in a) throw new en(a.error, `failed to get token accounts owned by account ${e.toBase58()}`);
                    return a.result
                }
                async getLargestAccounts(e) {
                    let t = { ...e,
                        ...
                        s = (0, m.vt)(i, te);
                    if ("error" in s) throw new en(s.error, "failed to get largest accounts");
                    return s.result
                }
                async getTokenLargestAccounts(e, t) {
                    let r = this._buildArgs([e.toBase58()], t),
                        ...
                        s = (0, m.vt)(i, e6);
                    if ("error" in s) throw new en(s.error, "failed to get token largest accounts");
                    return s.result
                }
                async getAccountInfoAndContext(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = ex(t), s = this._buildArgs([e.toBase58()], r, "base64", i), n = await this._rpcRequest("getAccountInfo", s), a = (0, m.vt)(n, eT((0, m.me)(tt)));
                    if ("error" in a) throw new en(a.error, `failed to get info about account ${e.toBase58()}`);
                    return a.result
                }
                async getParsedAccountInfo(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = ex(t), s = this._buildArgs([e.toBase58()], r, "jsonParsed", i), n = await this._rpcRequest("getAccountInfo", s), a = (0, m.vt)(n, eT((0, m.me)(ts)));
                    if ("error" in a) throw new en(a.error, `failed to get info about account ${e.toBase58()}`);
                    return a.result
                }
                ...
                async getMultipleParsedAccounts(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = ex(t), s = e.map(e => e.toBase58()), n = this._buildArgs([s], r, "jsonParsed", i), a = await this._rpcRequest("getMultipleAccounts", n), o = (0, m.vt)(a, eT((0, m.YO)((0, m.me)(ts))));
                    if ("error" in o) throw new en(o.error, `failed to get info for accounts ${s}`);
                    return o.result
                }
                async getMultipleAccountsInfoAndContext(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = ex(t), s = e.map(e => e.toBase58()), n = this._buildArgs([s], r, "base64", i), a = await this._rpcRequest("getMultipleAccounts", n), o = (0, m.vt)(a, eT((0, m.YO)((0, m.me)(tt))));
                    if ("error" in o) throw new en(o.error, `failed to get info for accounts ${s}`);
                    return o.result
                }
                ...
                async getStakeActivation(e, t, r) {
                    let {
                        commitment: i,
                        config: s
                    } = ex(t), n = this._buildArgs([e.toBase58()], i, void 0, { ...s,
                        epoch: null != r ? r : s ? .epoch
                    }), a = await this._rpcRequest("getStakeActivation", n), o = (0, m.vt)(a, eC(ta));
                    if ("error" in o) throw new en(o.error, `failed to get Stake Activation ${e.toBase58()}`);
                    return o.result
                }
                async getProgramAccounts(e, t) {
                    let {
                        ...
                        ...n.filters ? {
                            filters: eP(n.filters)
                        } : null
                    }), o = await this._rpcRequest("getProgramAccounts", a), c = (0, m.YO)(tr), l = !0 === n.withContext ? (0, m.vt)(o, eT(c)) : (0, m.vt)(o, eC(c));
                    if ("error" in l) throw new en(l.error, `failed to get accounts owned by program ${e.toBase58()}`);
                    return l.result
                }
                async getParsedProgramAccounts(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = ex(t), s = this._buildArgs([e.toBase58()], r, "jsonParsed", i), n = await this._rpcRequest("getProgramAccounts", s), a = (0, m.vt)(n, eC((0, m.YO)(tn)));
                    if ("error" in a) throw new en(a.error, `failed to get accounts owned by program ${e.toBase58()}`);
                    return a.result
                }
                async confirmTransaction(e, t) {
                    ...
                    return (R(64 === i.length, "signature has invalid length"), "string" == typeof e) ? await this.confirmTransactionUsingLegacyTimeoutStrategy({
                ...
                async confirmTransactionUsingDurableNonceStrategy({
                    ...
                    try {
                        ...
                        if (t.__type === V.PROCESSED) a = t.response;
                        else {
                            let i;
                            for (;;) {
                            ...
                            if (i ? .value) {
                                ...
                                switch (t) {
                                    case "processed":
                                    case "recent":
                                        if ("processed" !== r && "confirmed" !== r && "finalized" !== r) throw new T(n);
                                        break;
                                    case "confirmed":
                                    case "single":
                                    case "singleGossip":
                                        if ("confirmed" !== r && "finalized" !== r) throw new T(n);
                                        break;
                                    case "finalized":
                                    case "max":
                                    case "root":
                                        if ("finalized" !== r) throw new T(n)
                                }
                                a = {
                                    context: i.context,
                                    value: {
                ...
                async confirmTransactionUsingLegacyTimeoutStrategy({
                    ...
                    try {
                        ...
                        else throw new C(t, e.timeoutMs / 1e3)
                    } finally {
                        clearTimeout(r), n()
                    }
                    return i
                ...
                async getClusterNodes() {
                    let e = await this._rpcRequest("getClusterNodes", []),
                        t = (0, m.vt)(e, eC((0, m.YO)(ty)));
                    if ("error" in t) throw new en(t.error, "failed to get cluster nodes");
                    return t.result
                }
                async getVoteAccounts(e) {
                    let t = this._buildArgs([], e),
                        ...
                        i = (0, m.vt)(r, tk);
                    if ("error" in i) throw new en(i.error, "failed to get vote accounts");
                    return i.result
                }
                async getSlot(e) {
                    let {
                        commitment: t,
                        config: r
                    } = ex(e), i = this._buildArgs([], t, void 0, r), s = await this._rpcRequest("getSlot", i), n = (0, m.vt)(s, eC((0, m.ai)()));
                ...
                async getSlotLeader(e) {
                    let {
                        commitment: t,
                        config: r
                    } = ex(e), i = this._buildArgs([], t, void 0, r), s = await this._rpcRequest("getSlotLeader", i), n = (0, m.vt)(s, eC((0, m.Yj)()));
                ...
                async getSignatureStatuses(e, t) {
                    ...
                    let i = await this._rpcRequest("getSignatureStatuses", r),
                        s = (0, m.vt)(i, tv);
                    if ("error" in s) throw new en(s.error, "failed to get signature status");
                    return s.result
                }
                async getTransactionCount(e) {
                    let {
                        commitment: t,
                        config: r
                    } = ex(e), i = this._buildArgs([], t, void 0, r), s = await this._rpcRequest("getTransactionCount", i), n = (0, m.vt)(s, eC((0, m.ai)()));
                    if ("error" in n) throw new en(n.error, "failed to get transaction count");
                    return n.result
                }
                ...
                async getInflationReward(e, t, r) {
                    let {
                        commitment: i,
                        config: s
                    } = ex(r), n = this._buildArgs([e.map(e => e.toBase58())], i, void 0, { ...s,
                        epoch: null != t ? t : s ? .epoch
                    }), a = await this._rpcRequest("getInflationReward", n), o = (0, m.vt)(a, eK);
                    if ("error" in o) throw new en(o.error, "failed to get inflation reward");
                    return o.result
                }
                async getInflationRate() {
                    let e = await this._rpcRequest("getInflationRate", []),
                        t = (0, m.vt)(e, eZ);
                    if ("error" in t) throw new en(t.error, "failed to get inflation rate");
                    return t.result
                }
                async getEpochInfo(e) {
                    let {
                        commitment: t,
                        config: r
                    } = ex(e), i = this._buildArgs([], t, void 0, r), s = await this._rpcRequest("getEpochInfo", i), n = (0, m.vt)(s, e0);
                ...
                async getEpochSchedule() {
                    let e = await this._rpcRequest("getEpochSchedule", []),
                        t = (0, m.vt)(e, e1);
                    if ("error" in t) throw new en(t.error, "failed to get epoch schedule");
                    let r = t.result;
                    return new ew(r.slotsPerEpoch, r.leaderScheduleSlotOffset, r.warmup, r.firstNormalEpoch, r.firstNormalSlot)
                }
                async getLeaderSchedule() {
                    let e = await this._rpcRequest("getLeaderSchedule", []),
                        t = (0, m.vt)(e, e8);
                    if ("error" in t) throw new en(t.error, "failed to get leader schedule");
                    return t.result
                }
                ...
                async getRecentPerformanceSamples(e) {
                    let t = await this._rpcRequest("getRecentPerformanceSamples", e ? [e] : []),
                        r = (0, m.vt)(t, t0);
                    if ("error" in r) throw new en(r.error, "failed to get recent performance samples");
                    return r.result
                }
                async getFeeCalculatorForBlockhash(e, t) {
                    let r = this._buildArgs([e], t),
                        ...
                        s = (0, m.vt)(i, t1);
                    if ("error" in s) throw new en(s.error, "failed to get fee calculator");
                    let {
                        context: n,
                        value: a
                    } = s.result;
                ...
                async getFeeForMessage(e, t) {
                    let r = B(e.serialize()).toString("base64"),
                        ...
                        n = (0, m.vt)(s, eT((0, m.me)((0, m.ai)())));
                    if ("error" in n) throw new en(n.error, "failed to get fee for message");
                ...
                async getRecentPrioritizationFees(e) {
                    let t = e ? .lockedWritableAccounts ? .map(e => e.toBase58()),
                        ...
                        s = (0, m.vt)(i, eQ);
                    if ("error" in s) throw new en(s.error, "failed to get recent prioritization fees");
                    return s.result
                }
                ...
                async getLatestBlockhashAndContext(e) {
                    let {
                        commitment: t,
                        config: r
                    } = ex(e), i = this._buildArgs([], t, void 0, r), s = await this._rpcRequest("getLatestBlockhash", i), n = (0, m.vt)(s, tX);
                    if ("error" in n) throw new en(n.error, "failed to get latest blockhash");
                    return n.result
                }
                async isBlockhashValid(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = ex(t), s = this._buildArgs([e], r, void 0, i), n = await this._rpcRequest("isBlockhashValid", s), a = (0, m.vt)(n, tZ);
                    if ("error" in a) throw new en(a.error, "failed to determine if the blockhash `" + e + "`is valid");
                    return a.result
                }
                async getVersion() {
                ...
                async getBlock(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = ex(t), s = this._buildArgsAtLeastConfirmed([e], r, void 0, i), n = await this._rpcRequest("getBlock", s);
                    try {
                ...
                async getParsedBlock(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = ex(t), s = this._buildArgsAtLeastConfirmed([e], r, "jsonParsed", i), n = await this._rpcRequest("getBlock", s);
                    try {
                        switch (i ? .transactionDetails) {
                            case "accounts":
                                {
                ...
                async getBlockProduction(e) {
                    ...
                    let i = this._buildArgs([], r, "base64", t),
                        ...
                        n = (0, m.vt)(s, eG);
                    if ("error" in n) throw new en(n.error, "failed to get block production information");
                    return n.result
                }
                async getTransaction(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = ex(t), s = this._buildArgsAtLeastConfirmed([e], r, void 0, i), n = await this._rpcRequest("getTransaction", s), a = (0, m.vt)(n, tJ);
                ...
                async getParsedTransaction(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = ex(t), s = this._buildArgsAtLeastConfirmed([e], r, "jsonParsed", i), n = await this._rpcRequest("getTransaction", s), a = (0, m.vt)(n, tG);
                    if ("error" in a) throw new en(a.error, "failed to get transaction");
                    return a.result
                }
                async getParsedTransactions(e, t) {
                    ...
                    return (await this._rpcBatchRequest(s)).map(e => {
                        let t = (0, m.vt)(e, tG);
                        if ("error" in t) throw new en(t.error, "failed to get transactions");
                        return t.result
                    })
                }
                ...
                async getConfirmedBlock(e, t) {
                    let r = this._buildArgsAtLeastConfirmed([e], t),
                        ...
                        s = (0, m.vt)(i, tF);
                    if ("error" in s) throw new en(s.error, "failed to get confirmed block");
                    let n = s.result;
                    ...
                    return { ...a,
                        transactions: a.transactions.map(({
                            ...
                            meta: t,
                            transaction: X.populate(e.message, e.signatures)
                        }))
                    }
                }
                ...
                async getConfirmedTransaction(e, t) {
                    ...
                    let n = s.result;
                    if (!n) return n;
                    let a = new U(n.transaction.message),
                        o = n.transaction.signatures;
                    return { ...n,
                        transaction: X.populate(a, o)
                    }
                }
                async getParsedConfirmedTransaction(e, t) {
                    let r = this._buildArgsAtLeastConfirmed([e], t, "jsonParsed"),
                        i = await this._rpcRequest("getTransaction", r),
                        s = (0, m.vt)(i, tG);
                    if ("error" in s) throw new en(s.error, "failed to get confirmed transaction");
                    return s.result
                }
                async getParsedConfirmedTransactions(e, t) {
                    ...
                    return (await this._rpcBatchRequest(r)).map(e => {
                        let t = (0, m.vt)(e, tG);
                        if ("error" in t) throw new en(t.error, "failed to get confirmed transactions");
                        return t.result
                    })
                }
                ...
                async getConfirmedSignaturesForAddress2(e, t, r) {
                    let i = this._buildArgsAtLeastConfirmed([e.toBase58()], r, void 0, t),
                        ...
                        n = (0, m.vt)(s, to);
                    if ("error" in n) throw new en(n.error, "failed to get confirmed signatures for address");
                    return n.result
                }
                async getSignaturesForAddress(e, t, r) {
                    let i = this._buildArgsAtLeastConfirmed([e.toBase58()], r, void 0, t),
                        ...
                        n = (0, m.vt)(s, tc);
                    if ("error" in n) throw new en(n.error, "failed to get signatures for address");
                    return n.result
                }
                async getAddressLookupTable(e, t) {
                    ...
                    return null !== i && (s = new eI({
                        key: e,
                        state: eI.deserialize(i.data)
                    })), {
                        context: r,
                        value: s
                    }
                ...
                async requestAirdrop(e, t) {
                    let r = await this._rpcRequest("requestAirdrop", [e.toBase58(), t]),
                        i = (0, m.vt)(r, t8);
                    if ("error" in i) throw new en(i.error, `airdrop to ${e.toBase58()} failed`);
                    return i.result
                }
                ...
                async getStakeMinimumDelegation(e) {
                    let {
                        commitment: t,
                        config: r
                    } = ex(e), i = this._buildArgs([], t, "base64", r), s = await this._rpcRequest("getStakeMinimumDelegation", i), n = (0, m.vt)(s, eT((0, m.ai)()));
                    if ("error" in n) throw new en(n.error, "failed to get stake minimum delegation");
                    return n.result
                }
                async simulateTransaction(e, t, r) {
                    ...
                    if ("message" in e) {
                        ...
                        let a = t || {};
                        a.encoding = "base64", "commitment" in a || (a.commitment = this.commitment), t && "object" == typeof t && "innerInstructions" in t && (a.innerInstructions = t.innerInstructions);
                        let o = [s, a],
                    ...
                    if (e instanceof X ? ((i = new X).feePayer = e.feePayer, i.instructions = e.instructions, i.nonceInfo = e.nonceInfo, i.signatures = e.signatures) : (i = X.populate(e))._message = i._json = void 0, void 0 !== t && !Array.isArray(t)) throw Error("Invalid arguments");
                ...
                async sendEncodedTransaction(e, t) {
                    ...
                    if ("error" in o) {
                        let e;
                        throw "data" in o.error && (e = o.error.data.logs), new es({
                ...
                _wsOnClose(e) {
                    if (this._rpcWebSocketConnected = !1, this._rpcWebSocketGeneration = (this._rpcWebSocketGeneration + 1) % Number.MAX_SAFE_INTEGER, this._rpcWebSocketIdleTimeout && (clearTimeout(this._rpcWebSocketIdleTimeout), this._rpcWebSocketIdleTimeout = null), this._rpcWebSocketHeartbeat && (clearInterval(this._rpcWebSocketHeartbeat), this._rpcWebSocketHeartbeat = null), 1e3 === e) return void this._updateSubscriptions();
                ...
                _makeSubscription(e, t) {
                    ...
                    return void 0 === s ? this._subscriptionsByHash[i] = { ...e,
                        ...
                        R(void 0 !== t, `Could not find a \`Subscription\` when tearing down client subscription #${r}`), t.callbacks.delete(e.callback), await this._updateSubscriptions()
                ...
                onAccountChange(e, t, r) {
                    let {
                        commitment: i,
                        config: s
                    } = ex(r), n = this._buildArgs([e.toBase58()], i || this._commitment || "finalized", "base64", s);
                ...
                onProgramAccountChange(e, t, r, i) {
                    let {
                        commitment: s,
                        config: n
                    } = ex(r), a = this._buildArgs([e.toBase58()], s || this._commitment || "finalized", "base64", n || (i ? {
                        filters: eP(i)
                    } : void 0));
                    return this._makeSubscription({
                        callback: t,
            ...
            class t7 {
                constructor(e) {
                    this._keypair = void 0, this._keypair = e ? ? S()
                }
                static generate() {
                    return new t7(S())
                }
                ...
                static fromSeed(e) {
                    let t = I(e),
                        r = new Uint8Array(64);
                    return r.set(e), r.set(t, 32), new t7({
                        publicKey: t,
                        secretKey: r
                    })
                }
                get publicKey() {
                    return new E(this._keypair.publicKey)
                }
                get secretKey() {
            ...
            let t9 = Object.freeze({
                CreateLookupTable: {
                    index: 0,
                    layout: g.w3([g.DH("instruction"), eg("recentSlot"), g.u8("bumpSeed")])
                },
                FreezeLookupTable: {
                    index: 1,
                    layout: g.w3([g.DH("instruction")])
                ...
                ExtendLookupTable: {
                    index: 2,
                    layout: g.w3([g.DH("instruction"), eg(), g.O6(L(), g.cY(g.DH(), -8), "addresses")])
                },
            ...
            class re {
                ...
                static createLookupTable(e) {
                    let [t, r] = E.findProgramAddressSync([e.authority.toBuffer(), (0, p.eC)().encode(e.recentSlot)], this.programId), i = ec(t9.CreateLookupTable, {
            ...
            re.programId = new E("AddressLookupTab1e1111111111111111111111111");
            let rt = Object.freeze({
                ...
                SetComputeUnitPrice: {
                    index: 3,
                    layout: g.w3([g.u8("instruction"), eg("microLamports")])
                }
            });
            class rr {
                constructor() {}
            ...
            rr.programId = new E("ComputeBudget111111111111111111111111111111");
            let ri = g.w3([g.u8("numSignatures"), g.u8("padding"), g.NX("signatureOffset"), g.NX("signatureInstructionIndex"), g.NX("publicKeyOffset"), g.NX("publicKeyInstructionIndex"), g.NX("messageDataOffset"), g.NX("messageDataSize"), g.NX("messageInstructionIndex")]);
            class rs {
                constructor() {}
                static createInstructionWithPublicKey(e) {
                    ...
                    R(32 === t.length, `Public Key must be 32 bytes but received ${t.length} bytes`), R(64 === i.length, `Signature must be 64 bytes but received ${i.length} bytes`);
                    let a = ri.span,
                        o = a + t.length,
                        c = o + i.length,
                    ...
                    }, l), l.fill(t, a), l.fill(i, o), l.fill(r, c), new G({
                        keys: [],
                ...
                static createInstructionWithPrivateKey(e) {
                    ...
                    R(64 === t.length, `Private key must be 64 bytes but received ${t.length} bytes`);
                    try {
            ...
            rs.programId = new E("Ed25519SigVerify111111111111111111111111111");
            let rn = (e, t) => {
                let r = k.bI.sign(e, t);
                return [r.toCompactRawBytes(), r.recovery]
            };
            k.bI.utils.isValidPrivateKey;
            let ra = k.bI.getPublicKey,
                ro = g.w3([g.u8("numSignatures"), g.NX("signatureOffset"), g.u8("signatureInstructionIndex"), g.NX("ethAddressOffset"), g.u8("ethAddressInstructionIndex"), g.NX("messageDataOffset"), g.NX("messageDataSize"), g.u8("messageInstructionIndex"), g.av(20, "ethAddress"), g.av(64, "signature"), g.u8("recoveryId")]);
            class rc {
                constructor() {}
                static publicKeyToEthAddress(e) {
                    R(64 === e.length, `Public key must be 64 bytes but received ${e.length} bytes`);
                    try {
                        return n.Buffer.from((0, w.lY)(B(e))).slice(-20)
                    } catch (e) {
                ...
                static createInstructionWithPublicKey(e) {
                    ...
                    return rc.createInstructionWithEthAddress({
                        ethAddress: rc.publicKeyToEthAddress(t),
                        message: r,
                        signature: i,
                        recoveryId: s,
                        instructionIndex: n
                ...
                static createInstructionWithEthAddress(e) {
                    ...
                    R(20 === (t = "string" == typeof r ? r.startsWith("0x") ? n.Buffer.from(r.substr(2), "hex") : n.Buffer.from(r, "hex") : r).length, `Address must be 20 bytes but received ${t.length} bytes`);
                    let c = 12 + t.length,
                        l = c + s.length + 1,
                        u = n.Buffer.alloc(ro.span + i.length);
                    return ro.encode({
                        numSignatures: 1,
                        signatureOffset: c,
                ...
                static createInstructionWithPrivateKey(e) {
                    ...
                    R(32 === t.length, `Private key must be 32 bytes but received ${t.length} bytes`);
                    try {
                        let e = B(t),
                            s = ra(e, !1).slice(1),
                            a = n.Buffer.from((0, w.lY)(B(r))),
                            [o, c] = rn(a, e);
                        return this.createInstructionWithPublicKey({
                            publicKey: s,
                            message: r,
            ...
            rc.programId = new E("KeccakSecp256k11111111111111111111111111111");
            let rl = new E("StakeConfig11111111111111111111111111111111");
            class ru {
                constructor(e, t, r) {
                    this.unixTimestamp = void 0, this.epoch = void 0, this.custodian = void 0, this.unixTimestamp = e, this.epoch = t, this.custodian = r
                }
            }
            ru.default = new ru(0, 0, E.default);
            let rd = Object.freeze({
                Initialize: {
                    index: 0,
                    layout: g.w3([g.DH("instruction"), ((e = "authorized") => g.w3([L("staker"), L("withdrawer")], e))(), ((e = "lockup") => g.w3([g.Wg("unixTimestamp"), g.Wg("epoch"), L("custodian")], e))()])
                },
                Authorize: {
                    index: 1,
                    layout: g.w3([g.DH("instruction"), L("newAuthorized"), g.DH("stakeAuthorizationType")])
                },
                Delegate: {
                    index: 2,
                    layout: g.w3([g.DH("instruction")])
                ...
                AuthorizeWithSeed: {
                    index: 8,
                    layout: g.w3([g.DH("instruction"), L("newAuthorized"), g.DH("stakeAuthorizationType"), K("authoritySeed"), L("authorityOwner")])
                }
            });
            Object.freeze({
                Staker: {
            ...
            class rh {
                ...
                static initialize(e) {
                    let {
                        ...
                        authorized: r,
                        lockup: i
                    } = e, s = i || ru.default, n = ec(rd.Initialize, {
                        authorized: {
                        ...
                        lockup: {
                            ...
                            epoch: s.epoch,
                            custodian: B(s.custodian.toBuffer())
                        }
                    });
                    return new G({
                        keys: [{
            ...
            rh.programId = new E("Stake11111111111111111111111111111111111111"), rh.space = 200;
            let rg = Object.freeze({
                InitializeAccount: {
                    index: 0,
                    layout: g.w3([g.DH("instruction"), ((e = "voteInit") => g.w3([L("nodePubkey"), L("authorizedVoter"), L("authorizedWithdrawer"), g.u8("commission")], e))()])
                },
                Authorize: {
                    index: 1,
                    layout: g.w3([g.DH("instruction"), L("newAuthorized"), g.DH("voteAuthorizationType")])
                },
                Withdraw: {
                    index: 3,
                    layout: g.w3([g.DH("instruction"), g.Wg("lamports")])
                ...
                AuthorizeWithSeed: {
                    index: 10,
                    layout: g.w3([g.DH("instruction"), ((e = "voteAuthorizeWithSeedArgs") => g.w3([g.DH("voteAuthorizationType"), L("currentAuthorityDerivedKeyOwnerPubkey"), K("currentAuthorityDerivedKeySeed"), L("newAuthorized")], e))()])
                }
            });
            Object.freeze({
                Voter: {
            ...
            class rp {
                ...
                static initializeAccount(e) {
                    let {
                        ...
                        nodePubkey: r,
                        voteInit: i
                    } = e, s = ec(rg.InitializeAccount, {
                        voteInit: {
                            nodePubkey: B(i.nodePubkey.toBuffer()),
                            authorizedVoter: B(i.authorizedVoter.toBuffer()),
                            authorizedWithdrawer: B(i.authorizedWithdrawer.toBuffer()),
                ...
                static updateValidatorIdentity(e) {
                    let {
                        ...
                        authorizedWithdrawerPubkey: r,
                        nodePubkey: i
                    } = e, s = ec(rg.UpdateValidatorIdentity);
                    return new X().add({
                        keys: [{
                            pubkey: t,
                            isSigner: !1,
            ...
            rp.programId = new E("Vote111111111111111111111111111111111111111"), rp.space = 3762, new E("Va1idator1nfo111111111111111111111111111111"), (0, m.NW)({
                name: (0, m.Yj)(),
                website: (0, m.lq)((0, m.Yj)()),
                details: (0, m.lq)((0, m.Yj)()),
                iconUrl: (0, m.lq)((0, m.Yj)()),
                keybaseUsername: (0, m.lq)((0, m.Yj)())
