                        ...
                        <div class="main_auth _container"
                            ...
                            <div class="affiliate_block__Pro3B">
                                <div class="affiliate_card__tduYT bg-white">
                                    ...
                                    <div class="affiliate_list__G_zC9">
                                        <div
                                            class="flex flex-col justify-center items-center gap-[4px]">
                                            <img alt="icon" loading="lazy"
                                                width="24" height="25"
                                                decoding="async" data-nimg="1"
                                                style="color:transparent"
                                            ...
                                            <p
                                                class=" text-[10px]  font-[400] text-black leading-[1.5]">USDT</p>
                                            <p
                                                class="  text-[12px]  text-black">30</p>
                                        </div>
                                        <div
                                            class="affiliate_line__olesx bg-[#a1aebe]"></div>
                                        <div
                                            class="flex flex-col justify-center items-center gap-[4px]">
                                            <img alt="icon" loading="lazy"
                                                width="24" height="25"
                                            ...
                                            <p
                                                class=" text-[10px]  font-[400] text-black leading-[1.5]">USDT</p>
                                            <p
                                                class="  text-[12px]  text-black">75</p>
                                        </div>
                                        <div
                                            class="affiliate_line__olesx bg-[#a1aebe]"></div>
                                        <div
                                            ...
                                            <p
                                                class=" text-[10px]  font-[400] text-black leading-[1.5]">USDT</p>
                                            <p
                                                class="  text-[12px]  text-black">150</p>
                                        </div>
                                        <div
                                            class="affiliate_line__olesx bg-[#a1aebe]"></div>
                                        <div
                                            ...
                                            <p
                                                class=" text-[10px]  font-[400] text-black leading-[1.5]">USDT</p>
                                            <p
                                                class="  text-[12px]  text-black">300</p>
                                        </div>
                                        <div
                                            class="affiliate_line__olesx bg-[#a1aebe]"></div>
                                        <div
                                            ...
                                            <p
                                                class=" text-[10px]  font-[400] text-black leading-[1.5]">USDT</p>
                                            <p
                                                class="  text-[12px]  text-black">750</p>
                                        </div>
                                        <div
                                            class="affiliate_line__olesx bg-[#a1aebe]"></div>
                                        <div
                                            ...
                                            <p
                                                class=" text-[10px]  font-[400] text-black leading-[1.5]">USDT</p>
                                            <p
                                                class="  text-[12px]  text-black">1500</p>
                                        </div>
                                        <div
                                            class="affiliate_line__olesx bg-[#a1aebe]"></div>
                                        <div
                                            ...
                                            <p
                                                class=" text-[10px]  font-[400] text-black leading-[1.5]">USDT</p>
                                            <p
                                                class="  text-[12px]  text-black">3000</p>
                                        </div>
                                        <div
                                            class="affiliate_line__olesx bg-[#a1aebe]"></div>
                                        <div
                                            ...
                                            <p
                                                class=" text-[10px]  font-[400] text-black leading-[1.5]">USDT</p>
                                            <p
                                                class="  text-[12px]  text-black">7500</p>
                                        </div>
                                        <div
                                            class="affiliate_line__olesx bg-[#a1aebe]"></div>
                                        <div
                                            ...
                                            <p
                                                class=" text-[10px]  font-[400] text-black leading-[1.5]">USDT</p>
                                            <p
                                                class="  text-[12px]  text-black">15000</p>
                                        </div>
                                        <div
                                            class="affiliate_line__olesx bg-[#a1aebe]"></div>
                                        <div
                                            ...
                                            <p
                                                class=" text-[10px]  font-[400] text-black leading-[1.5]">USDT</p>
                                            <p
                                                class="  text-[12px]  text-black">30000</p>
                                        </div>
                                    </div>
                                    <div
                            ...
                            <div class="affiliate_table__lSTWG">
                                <div class="flex flex-col flex-grow">
                                    <div
                                        class="overflow-x-auto min-h-[350px] bg-white">
                                        <div class="relative w-full">
                                            <table
                                                class="w-full caption-bottom text-sm">
                                                <thead
                                                    class="border-b border-solid border-[#d9d9d9] bg-[#f3fbfc]">
                                                    <tr
                                                        class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                                        <th
                                                            class="text-[12px] font-light text-center text-[#303030] h-[73px] px-[16px] align-middle [&amp;:has([role=checkbox])]:pr-0">Date</th>
                                                        <th
                                                            class="text-[12px] font-light text-center text-[#303030] h-[73px] px-[16px] align-middle [&amp;:has([role=checkbox])]:pr-0">Login</th>
                                                        <th
                                                            class="text-[12px] font-light text-center text-[#303030] h-[73px] px-[16px] align-middle [&amp;:has([role=checkbox])]:pr-0">Amount
                                                            invested $</th>
                                                        <th
                                                            class="text-[12px] font-light text-center text-[#303030] h-[73px] px-[16px] align-middle [&amp;:has([role=checkbox])]:pr-0">Bonus
                                                            $</th>
                                                        <th
                                                            class="text-[12px] font-light text-center text-[#303030] h-[73px] px-[16px] align-middle [&amp;:has([role=checkbox])]:pr-0">
                                                            <div
                                                                class="flex justify-center items-center self-stretch gap-[16px]">
                                                                <p>LVL</p>
                                                            </div>
                                                        </th>
                                                    </tr>
                                                ...
                                                <caption
                                                    ...
                                                    <p
                                                        class="affiliate_available__iO8f5">No
                                                        Available Data</p>
                                                </caption>
                                                <tbody
                                                    class="[&amp;_tr:last-child]:border-0"></tbody>
                                            </table>
                                        </div>
                                    </div>
                                    <div
                                        class="affiliate_buttons_border__5Cqzo mt-auto "><button
                                            disabled
                                            class="button_border_body__yeuoF">Prev</button><button
                                            disabled
                                            class="button_border_body__yeuoF">Next</button></div>
                                </div>
                                <div class="flex-grow max-w-[486px]">
                                    <div
                                        class="affiliate_right__n8Fuj bg-white">
                                        <div class="relative w-full">
                                            <table
                                                class="w-full caption-bottom text-sm">
                                                <caption
                                                ...
                                                <thead
                                                    ...
                                                    <tr
                                                        class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                                        <th
                                                            class="text-[12px] font-light text-center text-[#303030] h-[73px] px-[16px] align-middle [&amp;:has([role=checkbox])]:pr-0">LVL</th>
                                                        <th
                                                            class="text-[12px] font-light text-center text-[#303030] h-[73px] px-[16px] align-middle [&amp;:has([role=checkbox])]:pr-0">%</th>
                                                        <th
                                                            class="text-[12px] font-light text-center text-[#303030] h-[73px] px-[16px] align-middle [&amp;:has([role=checkbox])]:pr-0">$
                                                            Turnover</th>
                                                        <th
                                                            ...
                                                            Earned</th>
                                                        <th
                                                            class="text-[12px] font-light text-center text-[#303030] h-[73px] px-[16px] align-middle [&amp;:has([role=checkbox])]:pr-0">Investors</th>
                                                    </tr>
                                                </thead>
                                                <tbody
                                                    class="[&amp;_tr:last-child]:border-0"></tbody>
