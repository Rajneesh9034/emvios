        ...
        <div class="self-stretch">
            <div class="my-accordion">
                ...
                <div class="my-accordion-content">
                    <form class="my-filter-form" method="GET" action="{{ route('user.bonus') }}">
                        ...
                        <input type="date" name="start_date" value="{{ request('start_date') }}" placeholder="start date"  style="height: 40px; padding: 6px 8px; font-size: 14px; border: 1px solid #ccc; border-radius: 4px;">
                        <input type="date" name="end_date" value="{{ request('end_date') }}" placeholder="end date"   style="height: 40px; padding: 6px 8px; font-size: 14px; border: 1px solid #ccc; border-radius: 4px;">
                        ...
                        <a href="{{ route('user.bonus') }}" class="reset">Reset</a>
