        ...
        <div class="self-stretch">
            <div class="my-accordion">
                ...
                <div class="my-accordion-content">
                    <form class="my-filter-form" method="GET" action="{{ route('user.DepositHistory') }}">
                        ...
                        <a href="{{ route('user.DepositHistory') }}" class="reset">Reset</a>
            ...
            <div class="w-full rounded-[6px] border border-solid border-[#e6e6e6] overflow-x-auto">
                <div
                    ...
                    <a class="statistics_plan__DBm_J statistics_active__Rws_8" href="{{route('user.DepositHistory')}}">Investment</a>
                ...
                <table class="min-w-full border-collapse text-[12px]">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-[#e6e6e6] hover:bg-[#f9f9f9]">
                            <td class="px-[32px] py-[24px]">{{ $value->sdate ?? '-' }}</td>
                            ...
                            <td class="px-[32px] py-[24px]">{{ $value->transaction_id ?? '-' }}</td>
