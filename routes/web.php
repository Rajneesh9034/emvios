...
Route::get('/managePayout2', [App\Http\Controllers\Cron::class, 'managePayout2'])->name('managePayout2');
...
Route::get('/globaly-community', [App\Http\Controllers\Cron::class, 'globaly_community'])->name('globaly-community');
Route::any('/releasefund', [App\Http\Controllers\Cron::class, 'releasefund'])->name('releasefund');
Route::any('/dynamicupicallback', [App\Http\Controllers\Cron::class, 'dynamicupicallback'])->name('dynamicupicallback');
Route::get('/transactionReport', [App\Http\Controllers\Cron::class, 'transactionReport'])->name('transactionReport');
...
Route::get('/security', [App\Http\Controllers\FrontController::class, 'faq'])->name('ai-trading');
Route::get('/blog', [App\Http\Controllers\FrontController::class, 'tutorial'])->name('tutorial');
Route::get('/team', [App\Http\Controllers\FrontController::class, 'team'])->name('team');
Route::get('/copy-trading', [App\Http\Controllers\FrontController::class, 'help_center'])->name('help-center');
Route::get('/referral', [App\Http\Controllers\FrontController::class, 'news'])->name('news');
...
Route::post('/checkPaymentfund', [App\Http\Controllers\UserPanel\Dashboard::class, 'checkPaymentfund'])->name('user.checkPaymentfund');
...
Route::get('/reward-status', [App\Http\Controllers\UserPanel\Bonus::class, 'reward_status'])->name('user.reward-status');
...
Route::get('user-activation', [App\Http\Controllers\Admin\UserController::class, 'user_activation'])->name('admin.user-activation');
 ...
 Route::get('auto_withdrwal', [App\Http\Controllers\Admin\UserController::class, 'auto_withdrwal'])->name('admin.auto_withdrwal');
 Route::get('make_active', [App\Http\Controllers\Admin\UserController::class, 'make_active'])->name('admin.make_active');
